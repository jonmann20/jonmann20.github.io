 ...
 * http://polymer.github.io/PATENTS.txt
 */
const ee=e=>t=>"function"==typeof t?((e,t)=>(window.customElements.define(e,t),t))(e,t):((e,t)=>{const{kind:s,elements:n}=t;return{kind:s,elements:n,finisher(t){window.customElements.define(e,t)}}})(e,t);ne((e,t)=>e.querySelector(t)),ne((e,t)=>e.querySelectorAll(t));const te=(e,t,s)=>{Object.defineProperty(t,s,e)},se=(e,t)=>({kind:"method",placement:"prototype",key:t.key,descriptor:e});function ne(e){return t=>(s,n)=>{const i={get(){return e(this.renderRoot,t)},enumerable:!0,configurable:!0};return void 0!==n?te(i,s,n):se(i,s)}}const ie="adoptedStyleSheets"in Document.prototype;s.d(t,"a",function(){return oe}),s.d(t,"b",function(){return ee}),s.d(t,"c",function(){return V});const re=e=>e.flat?e.flat(1/0):
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
*/const n=document.createElement("link");n.rel="stylesheet",n.href="https://fonts.googleapis.com/icon?family=Material+Icons",document.head.appendChild(n)},function(e,t,s){var n={"./a-side.js":[9,0],"./head-er.js":[8,1],"./page-ball-pit.js":[15,4],"./page-breakdancing-cube.js":[10,5],"./page-games.js":[11,6],"./page-home.js":[12,7],"./page-playground.js":[13,8],"./page-portfolio.js":[14,9],"./page-starry-background.js":[16,10],"./styles/base.js":[5,11],"./styles/carousel.js":[7,2],"./styles/page.js":[6,3]};function i(e){var t=n[e];return t?s.e(t[1]).then(function(){var e=t[0];return s(e)}):Promise.resolve().then(function(){var t=new Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t})}i.keys=function(){return Object.keys(n)},i.id=3,e.exports=i},function(e,t,s){"use strict";s.r(t);var n=s(0);
/**
@license
Copyright 2018 Google Inc. All Rights Reserved.
