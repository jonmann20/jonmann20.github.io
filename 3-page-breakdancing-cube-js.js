(window.webpackJsonp=window.webpackJsonp||[]).push([[5,3,11],{11:function(t,n,a){"use strict";a.r(n);var e=a(0),i=a(6),o=a(7),r=a(2),d=a(1);customElements.define("page-breakdancing-cube",class extends e.a{constructor(){super(),document.title="Breakdancing Cube | Playground",r.a.addMeta("description","Pure CSS3 animation demo."),r.a.addMeta("keywords","CSS3, HTML5")}firstUpdated(){d.a.openNav()}render(){return e.c`
			<style>
				${i.default}
				${o.default}
