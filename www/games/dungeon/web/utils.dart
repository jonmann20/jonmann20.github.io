...
class Utils {
	...
	bool checkCollision(a, b, [num moe=0]){
  	...
  	void placeTxt(String str, num fontSize, num x, num y, String color){
	    ctx.font = "$fontSize\px 'Press Start 2P'";
	    num tmpW = ctx.measureText(str).width;
	    
	    ctx.fillStyle = color;
	    ctx.fillText(str, x - tmpW/2, y);
  	}
  	
	void blinkTxt(num fontSize, num x, num y, [String str="PRESS ENTER"]){
	    if(alpha <= 0)
	    	fadeOut = false;
	    else if(alpha > 1.55)
	    	fadeOut = true;
	...
	bool flashTxt(num fontSize, String str){
