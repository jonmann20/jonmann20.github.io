...
$$.Game = {"": "Object;overworld,s",
  preGame$1: function(time) {
    if (this.s.startGame$0() === true)
      window.requestAnimationFrame$1(this.get$gameLoop());
    else
      window.requestAnimationFrame$1(this.get$preGame());
  },
  ...
  Game$0: function() {
    ...
    $.canvas.set$width(540);
    $.canvas.set$height(360);
    $.lvlSelected = false;
    $.curLvl = 1;
    $.key = $.Keyboard$();
    $.p = $.Player$();
    ...
    $.level = $.Level$();
    t1 = this.overworld;
    t2 = $.$$sub($.$$add($.$$index(t1.get$lvlArr(), t1.get$ovrCurLvl()).get$x(), $.$$div(this.overworld.get$boxW(), 2)), $.$$div($.p.get$w(), 2));
    $.p.set$x(t2);
    t2 = this.overworld;
    t3 = $.$$sub($.$$add($.$$index(t2.get$lvlArr(), t2.get$ovrCurLvl()).get$y(), $.$$div(this.overworld.get$boxH(), 2)), $.p.get$h());
    $.p.set$y(t3);
    this.s = $.StartScreen$();
    if ($.lvlSelected === true)
      this.overworld.setStartPosition$0();
    $.window().requestAnimationFrame$1(this.get$preGame());
  }
};

$$.Keyboard = {"": "Object;_liblib2$_keys>,lastKey=",
  isPressed$1: function(keyCode) {
    return this._liblib2$_keys.containsKey$1(keyCode);
  },
  Keyboard$0: function() {
    this.lastKey = 8;
    $.window().get$onKeyDown().listen$1(new $.anon2(this));
    $.window().get$onKeyUp().listen$1(new $.anon3(this));
  }
};

$$.StartScreen = {"": "Object;",
  startGame$0: function() {
    if ($.key.isPressed$1(13) === true || $.lvlSelected === true)
      return true;
    else
      return false;
  },
  StartScreen$0: function() {
    var img = $.ImageElement_ImageElement(null, null, null);
    img.set$src("img/startScreen.jpg");
    img.set$width($.canvas.get$width());
    img.set$height($.canvas.get$height());
    img.get$onLoad().listen$1(new $.anon(img));
  }
};

$$.Player = {"": "Object;x=,y=,vX,vY,w>,h>,maxVx,maxVy,attack,pImgReady<,pImg",
  update$0: function() {
    var tooFastY, tooFastX, t1;
    tooFastY = $.$$gt($.CONSTANT1.abs$0(this.vY), this.maxVy) === true && true;
    tooFastX = $.$$gt($.CONSTANT1.abs$0(this.vX), this.maxVx) === true && true;
    t1 = !tooFastY;
    if (t1 && $.key.isPressed$1(87) === true)
      this.vY = this.vY - 1;
    else if (t1 && $.key.isPressed$1(83) === true)
      this.vY = this.vY + 1;
    else {
      t1 = this.vY;
      if (t1 > 0)
    ...
    t1 = !tooFastX;
    if (t1 && $.key.isPressed$1(65) === true)
      this.vX = this.vX - 1;
    else if (t1 && $.key.isPressed$1(68) === true)
      this.vX = this.vX + 1;
    else {
      t1 = this.vX;
      if (t1 > 0)
    ...
    this.attack = $.key.isPressed$1(32) === true && true;
    this.x = $.$$add(this.x, this.vX);
    this.y = $.$$add(this.y, this.vY);
  },
  render$0: function() {
    this.draw$0();
    if (this.attack)
  ...
  draw$0: function() {
    if (this.pImgReady === true)
      $.ctx.drawImage$5(this.pImg, this.x, this.y, this.w, this.h);
  },
  drawAttack$0: function() {
    var t1 = $.ctx;
    t1.set$fillStyle("orange");
    t1.fillRect$4($.$$add(this.x, 32), $.$$sub(this.y, $.$$div($.p.get$h(), 2)), 7, 20);
    t1 = $.ctx;
    t1.set$fillStyle("#222");
    t1.fillRect$4($.$$add(this.x, 29), $.$$add($.$$sub(this.y, $.$$div($.p.get$h(), 2)), 11), 14, 4);
  },
  Player$0: function() {
    this.x = $.$$div($.canvas.get$width(), 2);
    this.y = $.$$div($.canvas.get$height(), 2);
    this.vX = 0;
    this.vY = 0;
    this.maxVy = 5;
    this.maxVx = 5;
    this.w = 28;
    this.h = 52;
    this.pImgReady = false;
    this.attack = false;
    this.pImg = $.ImageElement_ImageElement(null, null, null);
    this.pImg.set$src("img/player.gif");
    var t1 = this.w;
    this.pImg.set$width(t1);
    t1 = this.h;
    this.pImg.set$height(t1);
    this.pImg.get$onLoad().listen$1(new $.anon1(this));
  }
};

$$.lvl_t = {"": "Object;unlocked=,x=,y=",
  lvl_t$0: function() {
    this.unlocked = false;
    this.y = 0;
    this.x = 0;
...
$$.Overworld = {"": "Object;lvlArr>,ovrCurLvl>,boxW>,boxH>",
  update$0: function() {
    var t1, t2, t3;
    if ($.$$eq($.key.get$lastKey(), 87) === true)
      this.transition$1("u");
    if ($.$$eq($.key.get$lastKey(), 83) === true)
      this.transition$1("d");
    if ($.$$eq($.key.get$lastKey(), 65) === true)
      this.transition$1("l");
    if ($.$$eq($.key.get$lastKey(), 68) === true)
      this.transition$1("r");
    if ($.$$eq($.key.get$lastKey(), 13) === true) {
      t1 = this.lvlArr;
      t2 = this.ovrCurLvl;
      if (t2 < 0 || t2 >= t1.length)
        throw $.ioore(t2);
      t3 = t1[t2].get$unlocked() === true;
      t1 = t3;
    } else
      t1 = false;
    if (t1) {
      $.lvlSelected = true;
      t1 = $.$$index($.level.get$startPositions(), $.curLvl).get$x();
      $.p.set$x(t1);
      t1 = $.$$index($.level.get$startPositions(), $.curLvl).get$y();
      $.p.set$y(t1);
    }
  },
  setStartPosition$0: function() {
    var t1 = $.$$index($.level.get$startPositions(), $.curLvl).get$x();
    $.p.set$x(t1);
    t1 = $.$$index($.level.get$startPositions(), $.curLvl).get$y();
    $.p.set$y(t1);
  },
  transition$1: function(dir) {
    var t1, t2, fixX, t3, fixY, t4, t5;
    t1 = this.boxW;
    t2 = $.$$div($.p.get$w(), 2);
    if (typeof t2 !== "number")
      throw $.iae(t2);
    ...
    if (t2) {
      ...
      if (t1 < 0 || t1 >= t2.length)
        throw $.ioore(t1);
      t3 = $.$$add(t2[t1].get$x(), fixX);
      $.p.set$x(t3);
      t3 = this.lvlArr;
      t4 = this.ovrCurLvl;
      if (t4 < 0 || t4 >= t3.length)
        throw $.ioore(t4);
      t5 = $.$$add(t3[t4].get$y(), fixY);
      $.p.set$y(t5);
    } else if (t1 === 1)
      if (dir === "l") {
        t2 = this.lvlArr;
  ...
  render$0: function() {
    var grd, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14;
    grd = $.ctx.createRadialGradient$6(238, 50, 10, 238, 50, 300);
    grd.addColorStop$2(0, "#8ed6ff");
    grd.addColorStop$2(1, "#004cb3");
    t1 = $.ctx;
    t1.set$fillStyle(grd);
    t1.fillRect$4(0, 0, $.canvas.get$width(), $.canvas.get$height());
    t1 = $.ctx;
    t1.set$fillStyle("#e1e1e1");
    t1.set$font("18px Helvetica");
    $.ctx.fillText$3("World 1", $.$$sub($.$$div($.canvas.get$width(), 2), 20), 28);
    t1 = $.ctx;
    ...
    if (0 >= t2.length)
      throw $.ioore(0);
    t2 = t2[0];
    t1.fillRect$4(t2.get$x(), t2.get$y(), this.boxW, this.boxH);
    t1 = $.ctx;
    t1.set$fillStyle("#e1e1e1");
    t1.set$font("10px Helvetica");
    t1 = $.ctx;
    t3 = this.lvlArr;
    if (0 >= t3.length)
      throw $.ioore(0);
    t4 = $.$$add(t3[0].get$x(), 10);
    t5 = this.lvlArr;
    if (0 >= t5.length)
      throw $.ioore(0);
    t1.fillText$3("Start", t4, $.$$add(t5[0].get$y(), 61));
    t4 = $.ctx;
    t4.set$strokeStyle("red");
    t4.set$lineWidth(3);
    t4.beginPath$0();
    t4 = $.ctx;
    t1 = this.lvlArr;
    if (0 >= t1.length)
      throw $.ioore(0);
    t6 = $.$$add(t1[0].get$x(), this.boxW);
    t7 = this.lvlArr;
    if (0 >= t7.length)
      throw $.ioore(0);
    t4.moveTo$2(t6, $.$$add(t7[0].get$y(), this.boxH / 2));
    t6 = $.ctx;
    t4 = this.lvlArr;
    if (1 >= t4.length)
      throw $.ioore(1);
    t4 = t4[1];
    t6.lineTo$2(t4.get$x(), $.$$add(t4.get$y(), this.boxH / 2));
    $.ctx.stroke$0();
    $.ctx.closePath$0();
    t6 = $.ctx;
    t6.set$fillStyle("red");
    t8 = this.lvlArr;
    if (1 >= t8.length)
      throw $.ioore(1);
    t8 = t8[1];
    t6.fillRect$4(t8.get$x(), t8.get$y(), this.boxW, this.boxH);
    t6 = $.ctx;
    t6.set$fillStyle("#e1e1e1");
    t9 = this.lvlArr;
    if (1 >= t9.length)
      throw $.ioore(1);
    t10 = $.$$add(t9[1].get$x(), 6);
    t11 = this.lvlArr;
    if (1 >= t11.length)
      throw $.ioore(1);
    t6.fillText$3("Level 1", t10, $.$$add(t11[1].get$y(), 61));
    t10 = $.ctx;
    t10.set$strokeStyle("red");
    t10.beginPath$0();
    t10 = $.ctx;
    t6 = this.lvlArr;
    if (1 >= t6.length)
      throw $.ioore(1);
    t12 = $.$$add(t6[1].get$x(), this.boxW);
    t13 = this.lvlArr;
    if (1 >= t13.length)
      throw $.ioore(1);
    t10.moveTo$2(t12, $.$$add(t13[1].get$y(), this.boxH / 2));
    t12 = $.ctx;
    t10 = this.lvlArr;
    if (2 >= t10.length)
      throw $.ioore(2);
    t12.lineTo$2(t10[2].get$x(), $.$$add(t10[1].get$y(), this.boxH / 2));
    t12 = $.ctx;
    t14 = this.lvlArr;
    if (2 >= t14.length)
      throw $.ioore(2);
    t14 = t14[2];
    t12.lineTo$2(t14.get$x(), t14.get$y());
    $.ctx.stroke$0();
    $.ctx.closePath$0();
    t1 = this.lvlArr;
    if (2 >= t1.length)
      throw $.ioore(2);
    t1 = t1[2].get$unlocked() === true ? "red" : "blue";
    t2 = $.ctx;
    t2.set$fillStyle(t1);
    t1 = this.lvlArr;
    if (2 >= t1.length)
      throw $.ioore(2);
    t3 = $.$$sub(t1[2].get$x(), this.boxW / 2);
    t4 = this.lvlArr;
    if (2 >= t4.length)
      throw $.ioore(2);
    t2.fillRect$4(t3, t4[2].get$y(), this.boxW, this.boxH);
    t3 = $.ctx;
    t3.set$fillStyle("#e1e1e1");
    t2 = this.lvlArr;
    if (2 >= t2.length)
      throw $.ioore(2);
    t5 = $.$$sub($.$$add(t2[2].get$x(), 6), this.boxW / 2);
    t6 = this.lvlArr;
    if (2 >= t6.length)
      throw $.ioore(2);
    t3.fillText$3("Level 2", t5, $.$$add(t6[2].get$y(), 61));
    $.p.draw$0();
  },
  Overworld$0: function() {
    ...
    this.boxH = 44;
    this.boxW = 44;
    this.lvlArr = $.List_List$fixedLength(10, null);
    for (i = 0; t1 = this.lvlArr, i < 10; ++i) {
      t2 = $.lvl_t$();
      if (i >= t1.length)
        throw $.ioore(i);
      t1[i] = t2;
    ...
    if (0 >= t1.length)
      throw $.ioore(0);
    t1[0].set$unlocked(false);
    t2 = this.lvlArr;
    if (0 >= t2.length)
      throw $.ioore(0);
    t2[0].set$x(30);
    t3 = $.$$div($.canvas.get$height(), 3);
    t4 = this.lvlArr;
    if (0 >= t4.length)
      throw $.ioore(0);
    t4[0].set$y(t3);
    ...
    if (1 >= t3.length)
      throw $.ioore(1);
    t3[1].set$unlocked(true);
    t5 = this.lvlArr;
    if (1 >= t5.length)
      throw $.ioore(1);
    t5[1].set$x(120);
    t6 = $.$$div($.canvas.get$height(), 3);
    t7 = this.lvlArr;
    if (1 >= t7.length)
      throw $.ioore(1);
    t7[1].set$y(t6);
    ...
    if (2 >= t6.length)
      throw $.ioore(2);
    t6[2].set$unlocked(false);
    t8 = this.lvlArr;
    if (2 >= t8.length)
      throw $.ioore(2);
    t8[2].set$x(210);
    t9 = $.$$div($.canvas.get$height(), 2);
    t10 = this.lvlArr;
    if (2 >= t10.length)
      throw $.ioore(2);
    t10[2].set$y(t9);
...
$$.Level = {"": "Object;NUM_LVLS,startPositions>,level1",
  update$0: function() {
    if ($.$$eq($.curLvl, 1) === true)
  ...
  Level$0: function() {
    ...
    this.level1 = $.Level_1$();
    this.NUM_LVLS = 2;
    this.startPositions = $.List_List$fixedLength(this.NUM_LVLS, null);
    for (i = 0; i < this.NUM_LVLS; ++i) {
    ...
    t1 = $.$$div($.canvas.get$width(), 2);
    t2 = this.startPositions;
    if (1 >= t2.length)
      throw $.ioore(1);
    t2[1].set$x(t1);
    t1 = $.$$sub($.$$sub($.canvas.get$height(), $.p.get$h()), 10);
...
$$.Level_1 = {"": "Object;wise",
  ...
  render$0: function() {
    ...
    t1.set$fillStyle("#e1e1e1");
    t1.set$font("18px Helvetica");
    $.ctx.fillText$3("Level 1", $.$$sub($.$$div($.canvas.get$width(), 2), 12), 19);
    t1 = $.ctx;
    t1.set$fillStyle("green");
    t2 = this.wise;
    t1.fillRect$4(t2.x, t2.y, t2.w, t2.h);
    t1 = $.ctx;
    t1.set$fillStyle("#000");
    t1.fillRect$4($.$$add(this.wise.x, 19), $.$$sub(this.wise.y, 56), 130, 50);
    t1 = $.ctx;
    t1.set$fillStyle("#e1e1e1");
    t1.fillRect$4($.$$add(this.wise.x, 20), $.$$sub(this.wise.y, 55), 128, 48);
    t1 = $.ctx;
    t1.set$fillStyle("#000");
    t1.set$font("12px Helvetica");
    $.ctx.fillText$3("Hello, I am Wise Man.", $.$$add(this.wise.x, 24), $.$$sub(this.wise.y, 30));
  },
  Level_1$0: function() {
    this.wise = $.WiseMan$();
  }
...
$$.anon = {"": "Closure;img_0",
  call$1: function(e) {
    var t1;
    $.ctx.drawImage$5(this.img_0, 0, 0, $.canvas.get$width(), $.canvas.get$height());
    t1 = $.ctx;
    t1.set$fillStyle("red");
    t1.set$font("18px Helvetica");
    $.ctx.fillText$3("Press", $.$$sub($.$$div($.canvas.get$width(), 2), 2), $.$$add($.$$div($.canvas.get$height(), 2), 27));
  }
};
...
$$.anon1 = {"": "Closure;this_0",
  call$1: function(e) {
    this.this_0.set$pImgReady(true);
  }
};
...
$$.anon2 = {"": "Closure;this_0",
  call$1: function(e) {
    ...
    t2 = this.this_0;
    t2.set$lastKey(t1);
    if (t2.get$_liblib2$_keys().containsKey$1(e.get$keyCode()) !== true)
      $.$$indexSet(t2.get$_liblib2$_keys(), e.get$keyCode(), e.get$timeStamp());
  }
};
...
$$.anon3 = {"": "Closure;this_1",
  call$1: function(e) {
    e.preventDefault$0();
    $.remove(this.this_1.get$_liblib2$_keys(), e.get$keyCode());
  }
};
...
$.Keyboard$ = function() {
  var t1 = new $.Keyboard($.Map_Map(), null);
  t1.Keyboard$0();
  return t1;
};

$.startPos$ = function() {
  var t1 = new $.startPos(null, null);
  t1.startPos$0();
  return t1;
};

$.Level$ = function() {
  var t1 = new $.Level(null, null, null);
  t1.Level$0();
  return t1;
};

$.WiseMan$ = function() {
  var t1 = new $.WiseMan(null, null, null, null);
  t1.WiseMan$0();
  return t1;
};

$.Level_1$ = function() {
  var t1 = new $.Level_1(null);
  t1.Level_1$0();
  return t1;
};

$.lvl_t$ = function() {
  var t1 = new $.lvl_t(null, null, null);
  t1.lvl_t$0();
  return t1;
};

$.Overworld$ = function() {
  var t1 = new $.Overworld(null, null, null, null);
  t1.Overworld$0();
  return t1;
};

$.Player$ = function() {
  var t1 = new $.Player(null, null, null, null, null, null, null, null, null, null, null);
  t1.Player$0();
  return t1;
};
...
$.CONSTANT6 = new Isolate.$isolateProperties.EventStreamProvider("keyup");
$.lazyPort = null;
