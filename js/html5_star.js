(function(a){
    a.fn.star_bg = function (p) {
        var p = p || {};

        var w_w = p && p.window_width ? p.window_width : "720";
        ...
        var numPoints = s_c;
        a(this).attr({ width: w_w, height: w_h });
        setup();
        ...
        function setup() {
            ...
            function draw3Din2D(point3d) {
                ...
                var x2d = (x3d * scale) + HALF_WIDTH - mouse_x / 3;
                var y2d = (y3d * scale) + HALF_HEIGHT - mouse_y / 3;
