...
module.exports = (gulp, isDev, iff, concat, sourcemaps, replace, fs) => {
	...
	return (() => {
		...
		gulp.task('css:inlineVamp', () => inline('games/vamp/index.html', '/games/common/css/main.css', './games/vamp'));
		gulp.task('css:inlineDormanticide', () => inline('games/dormanticide/index.html', '/games/common/css/main.css', './games/dormanticide'));
