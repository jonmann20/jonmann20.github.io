...
$$.BoundClosure$1 = [F, {"": "BoundClosure;_self,_liblib2$_target,_receiver,_liblib2$_name",
  call$1: function(p0) {
...
Duration: {"": "Object;_duration<",
  ...
  $sub: function(_, other) {
    ...
    if (typeof t1 !== "number")
      throw H.iae(t1);
    return new P.Duration(0 + C.JSNumber_methods.$sub(this._duration, t1));
  },
  $lt: function(_, other) {
    var t1 = other.get$_duration();
    if (typeof t1 !== "number")
...
_ElementCssClassSet: {"": "CssClassSetImpl;_liblib3$_element",
  readClasses$0: function() {
    var s, t1, trimmed;
    s = P.LinkedHashSet_LinkedHashSet(null, null, null, J.JSString);
    for (t1 = this._liblib3$_element.className.split(" "), t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
...
DeviceOrientationEvent: {"": "Event;", $isDeviceOrientationEvent: true, $asDeviceOrientationEvent: null},
...
_AttributeClassSet: {"": "CssClassSetImpl;_element",
  readClasses$0: function() {
    var classname, s, t1, trimmed;
    classname = new W._ElementAttributeMap(this._element)._liblib3$_element.getAttribute("class");
    s = P.LinkedHashSet_LinkedHashSet(null, null, null, J.JSString);
    if (classname == null)
      return s;
  ...
  writeClasses$1: function(s) {
    new W._ElementAttributeMap(this._element)._liblib3$_element.setAttribute("class", s.join$1(s, " "));
  }
},
...
main: function() {
  ...
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, new F.main_closure(), t1._useCapture);
...
Enemy: {"": "GameObj;initHealth,health,invincibleTimer,invincible,captured,imgCardReady,animate,cardSrc,name,imgCard,hdir,vdir,ix,iy,w,h,x,y,ready,img,src",
  ...
  Enemy$8: function(initHealth, cardSrc, $name, ix, iy, w, h, src) {
    ...
    if (t1 != null) {
      ...
      t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, new F.Enemy_closure(this), t1._useCapture);
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t2._tryResume$0();
    }
  },
...
Game: {"": "Object;fpsHolder,oldTime,fps,w,h,invRatio",
  ...
  get$gameLoop: function() {
    return new F.BoundClosure$1(this, F.Game.prototype.gameLoop$1, null, "gameLoop$1");
  },
  ...
  Game$0: function() {
    ...
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, new F.Game_closure(this), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = C.EventStreamProvider_deviceorientation.forTarget$1(window);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, new F.Game_closure0(this), t2._useCapture);
...
GameObj: {"": "Object;ix,iy,w<,h<,x>,y>,ready,img,src",
  ...
  GameObj$5: function(ix, iy, w, h, str) {
    ...
    if (this.src != null) {
      ...
      t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, new F.GameObj_closure(this), t1._useCapture);
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t2._tryResume$0();
    }
  },
...
Keyboard: {"": "Object;_keys,lastKeyDown,lastKeyUp,lastDirDown,lastDirUp,theKey,r",
  ...
  Keyboard$0: function() {
    ...
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, new F.Keyboard_closure(this), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = C.EventStreamProvider_keyup.forTarget$1(window);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, new F.Keyboard_closure0(this), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
  },
  static: {
...
Level_1: {"": "Object;wise,fish,dialog,underground,transitionOver",
  ...
  canvasTransition$0: function() {
    ...
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, new F.Level_1_canvasTransition_closure(this), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    $.canvasListener = t2;
  },
...
Overworld: {"": "Object;lvlArr,ovrCurLvl,fixX,fixY,boxW,boxH,boxPadBot",
  update$0: function() {
    ...
    if (t2) {
      ...
      t1.get$onTransitionEnd;
      t1 = C._CustomEventStreamProvider__determineTransitionEventType.forElement$1(t1);
      t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, new F.Overworld_update_closure(this), t1._useCapture);
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t2._tryResume$0();
      $.canvasListener = t2;
    }
...
Player: {"": "GameObj;vX,vY,maxVx,maxVy,maxV,health,maxHealth,invincibleTimer,atkDownTime,atkUpTime,prevDir,dir,movLocked,invincible,invisible,heart,device,sword,animal,imgD,imgL,imgR,imgU,imgPicked,ix,iy,w,h,x,y,ready,img,src",
  update$0: function() {
    ...
    if (!this.movLocked) {
      ...
      if ($.key._keys.containsKey$1(32))
        ;
      t1 = this.sword;
      t1.inUse = t1.usable && $.key._keys.containsKey$1(32) && true;
      t1 = this.device;
      t1.inUse = t1.usable && $.key._keys.containsKey$1(16) && true;
    }
  },
  updatePosition$0: function() {
    ...
    if (Math.abs(this.vY) < 0.5)
      this.vY = 0;
    if (!tooFastY) {
      if ($.key._keys.containsKey$1(38)) {
        this.vY = this.vY - 1;
        this.dir = 38;
      }
      if ($.key._keys.containsKey$1(40)) {
        this.vY = this.vY + 1;
        this.dir = 40;
      }
    }
    if (!tooFastX) {
      if ($.key._keys.containsKey$1(37)) {
        this.vX = this.vX - 1;
        this.dir = 37;
      }
      if ($.key._keys.containsKey$1(39)) {
        this.vX = this.vX + 1;
        this.dir = 39;
      }
    }
    if (!($.key._keys.containsKey$1(38) && $.key._keys.containsKey$1(37)))
      if (!($.key._keys.containsKey$1(38) && $.key._keys.containsKey$1(39)))
        if (!($.key._keys.containsKey$1(40) && $.key._keys.containsKey$1(37)))
          t1 = $.key._keys.containsKey$1(40) && $.key._keys.containsKey$1(39);
        else
          t1 = true;
      else
        t1 = true;
...
StartScreen: {"": "Object;isOptions,linkClicked,ret,ent,OPEN_GAME,OPEN_START,mouse,newGame,linkColor,mouseMoveE,mouseClickE",
  ...
  get$startScreenLoop: function() {
    return new F.BoundClosure$1(this, F.StartScreen.prototype.startScreenLoop$1, null, "startScreenLoop$1");
  },
  startScreen$0: function() {
    if ($.key._keys.containsKey$1(13) || $.DEBUG_OVERWORLD || $.DEBUG_LVL) {
      $.key.lastKeyDown = 8;
      this.mouseEvents$0();
      return true;
    }
...
CssClassSetImpl: {"": "Object;",
  ...
  add$1: function(_, value) {
    ...
    new P.CssClassSetImpl_add_closure(value).call$1(s);
...
function dart_precompiled($collectedClasses) {
  ...
  function _ZoneTimer(_zone, _liblib4$_callback, _timer) {
    this._zone = _zone;
  ...
  function _ElementCssClassSet(_liblib3$_element) {
    this._liblib3$_element = _liblib3$_element;
  }
  ...
  GameObj.prototype.get$w = function() {
    return this.w;
  };
  GameObj.prototype.get$h = function() {
    return this.h;
  };
  GameObj.prototype.get$x = function(receiver) {
    return this.x;
  };
  GameObj.prototype.get$y = function(receiver) {
    return this.y;
  };
  ...
  function Keyboard(_keys, lastKeyDown, lastKeyUp, lastDirDown, lastDirUp, theKey, r) {
    this._keys = _keys;
  ...
  function StartScreen_mouseEvents_closure(this_0) {
    this.this_0 = this_0;
  }
  StartScreen_mouseEvents_closure.builtin$cls = "StartScreen_mouseEvents_closure";
  if (!"name" in StartScreen_mouseEvents_closure)
    StartScreen_mouseEvents_closure.name = "StartScreen_mouseEvents_closure";
  $desc = $collectedClasses.StartScreen_mouseEvents_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StartScreen_mouseEvents_closure.prototype = $desc;
  function StartScreen_mouseEvents_closure0(this_1) {
    this.this_1 = this_1;
  }
  StartScreen_mouseEvents_closure0.builtin$cls = "StartScreen_mouseEvents_closure0";
  if (!"name" in StartScreen_mouseEvents_closure0)
    StartScreen_mouseEvents_closure0.name = "StartScreen_mouseEvents_closure0";
  $desc = $collectedClasses.StartScreen_mouseEvents_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StartScreen_mouseEvents_closure0.prototype = $desc;
  ...
  Rect.prototype.get$w = function() {
    return this.w;
  };
  Rect.prototype.get$h = function() {
    return this.h;
  };
  ...
  UIEvent.prototype.get$_layerX = function(receiver) {
    return receiver.layerX;
  };
  UIEvent.prototype.get$_layerY = function(receiver) {
