...
class Arena {
	...
	void drawStage1(){
	    ...
	    ctx.fillRect(HALFW - 230, 110, HALFW + 40, HALFH);
	    
	    if(animalSelected != -1){
	      	p.animal[animalSelected].drawD(HALFW - 100 - p.animal[animalSelected].w/2, FULLH - 190);
	    }
	    else {
	      	drawAnimalSelector();
	    }
	    ...
	    ctx.fillRect(FULLW - 280, 40, 35, 35);
  	}
	...
	void drawStageSelector(){
	    ...
	    util.blinkTxt(9, HALFW, HALFH - 120);
	}
}