...
InputElement: {"": "HtmlElement;height%,name=,src},value=,width%", "%": "HTMLInputElement"},
...
TransitionEvent: {"": "Event;", "%": "TransitionEvent|WebKitTransitionEvent"},
...
Enemy: {"": "GameObj;ACCELERATION,initHealth,health,invincibleTimer,movTimer,invincible,captured,imgCardReady,animate,cardSrc,name,imgCard,ix,iy,w,h,x,y,ready,img,src",
  ...
  drawCard$0: function() {
    ...
    if (this.imgCardReady) {
      ...
      if (typeof t5 !== "number")
        throw t5.$sub();
      J.drawImageScaled$5$x(t1, t2, t3 - t4 / 2, t5 - t8 / 2, t7.get$width(t6), t8);
      t8 = $.overworld;
      t8.reset$0(t8);
    }
  },
  drawHealth$0: function() {
    ...
    J.fillRect$4$x(t1, t2 + t3 / 2 - 1, this.y - 15, t4 + 2, 8.2);
    J.set$fillStyle$x($.ctx, "#777");
    t3 = $.ctx;
    t2 = this.x;
    t1 = this.w;
    if (typeof t1 !== "number")
      throw t1.$div();
    J.fillRect$4$x(t3, t2 + t1 / 2, this.y - 14, t4, 6);
    J.set$fillStyle$x($.ctx, "red");
    for (i = 0; i < this.health; ++i) {
      ...
      if (typeof t3 !== "number")
        throw t3.$div();
      J.fillRect$4$x(t1, t2 + t3 / 2 + 5 * i, this.y - 14, 5, 6);
    }
  },
  Enemy$8: function(initHealth, cardSrc, $name, ix, iy, w, h, src) {
    ...
    if (t1 != null) {
      ...
      t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.Enemy_closure(this)), t1._useCapture);
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t2._tryResume$0();
    }
  },
...
Game: {"": "Object;fpsHolder,oldTime,fps,w,h,invRatio",
  ...
  get$gameLoop: function() {
    return new H.BoundClosure$1(this, F.Game.prototype.gameLoop$1, null, "gameLoop$1");
  },
  update$0: function() {
  ...
  displayFps$2: function(t, old) {
    ...
    if (typeof t2 !== "number")
      throw t2.$div();
    $.dt = t2 / 1000;
    if (C.JSInt_methods.$mod(t1.toInt$0(t), 12) === 0) {
      t1 = $.dt;
      if (typeof t1 !== "number")
        throw H.iae(t1);
  ...
  Game$0: function() {
    ...
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.Game_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = C.EventStreamProvider_deviceorientation.forTarget$1(window);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new F.Game_closure0(this)), t2._useCapture);
    ...
    if (t4 >>> 0 !== t4 || t4 >= t3.length)
      throw H.ioore(t3, t4);
    t1.x = t3[t4].x + t2.fixX;
    t4 = t2.lvlArr;
    t3 = t2.ovrCurLvl;
    if (t3 >>> 0 !== t3 || t3 >= t4.length)
      throw H.ioore(t4, t3);
    t1.y = t4[t3].y + t2.fixY;
...
GameObj: {"": "Object;ix,iy,w,h,x,y,ready,img,src",
  draw$1: function(sp) {
    ...
    if (this.src != null && this.ready) {
      ...
      t6 = this.w;
      if (sp != null)
        J.drawImageScaledFromSource$9$x(t2, t4, sp.sx, sp.sy, t6, t5, t3, t1, t6, t5);
      else
        J.drawImageScaled$5$x(t2, t4, t3, t1, t6, t5);
    } else {
      J.set$fillStyle$x($.ctx, "#444");
      J.fillRect$4$x($.ctx, this.x, this.y, this.w, this.h);
    }
  },
  draw$0: function() {
  ...
  GameObj$5: function(ix, iy, w, h, str) {
    ...
    if (this.src != null) {
      ...
      t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.GameObj_closure(this)), t1._useCapture);
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t2._tryResume$0();
    }
  },
...
Keyboard_closure: {"": "Closure;this_0",
  call$1: function(e) {
    var t1, t2, t3;
    t1 = this.this_0;
    t1.theKey = t1.convertWASD$1(J.get$keyCode$x(e));
    t2 = t1._keys;
    if (!t2.containsKey$1(t1.theKey.key)) {
      t3 = t1.theKey;
      if (t3.isDirectionKey === true)
        t1.lastDirDown = t3.key;
      t1.lastKeyDown = t1.theKey.key;
      t2.$indexSet(t2, t1.theKey.key, e.timeStamp);
    }
  },
  $is_args1: true
},
...
Arena: {"": "Object;curStage,numStages,animalSelected,stage,stageSelected",
  ...
  drawStage1$0: function() {
    var t1, t2, t3, t4;
    J.set$fillStyle$x($.ctx, "#111");
    J.fillRect$4$x($.ctx, 0, 0, $.FULLW, $.FULLH);
    J.set$fillStyle$x($.ctx, C.Color_Yf3.name);
    t1 = $.ctx;
    t2 = $.get$HALFW();
    if (typeof t2 !== "number")
      throw t2.$sub();
    J.fillRect$4$x(t1, t2 - 100, 70, $.get$HALFW(), $.get$HALFH());
    ...
    J.set$fillStyle$x($.ctx, "orange");
    J.fillRect$4$x($.ctx, $.FULLW - 250, 20, 35, 35);
  },
  drawAnimalSelector$0: function() {
    var t1, t2, len, i, t3;
    J.set$fillStyle$x($.ctx, "#ccc");
    t1 = $.ctx;
    t2 = $.get$HALFW();
    if (typeof t2 !== "number")
      throw t2.$sub();
    J.fillRect$4$x(t1, t2 - 50, $.FULLH - 90, 155, 65);
    J.set$font$x($.ctx, "9px 'Press Start 2P'");
    J.set$fillStyle$x($.ctx, "#000");
    t2 = $.ctx;
    t1 = $.get$HALFW();
    if (typeof t1 !== "number")
      throw t1.$sub();
    J.fillText$3$x(t2, "SELECT ANIMAL", t1 - 30, $.FULLH - 74);
    J.set$font$x($.ctx, "8px 'Press Start 2P'");
    J.set$fillStyle$x($.ctx, "#333");
    len = $.p.animal.length;
    for (i = 0; i < len; ++i) {
      t1 = $.ctx;
      t2 = $.p.animal;
      ...
      if (typeof t3 !== "number")
        throw t3.$sub();
      J.fillText$3$x(t1, t2, t3 - 42, $.FULLH - 58);
    }
  },
  drawStageSelector$0: function() {
    ...
    for (t1 = this.numStages, t2 = C.Color_Yf3.name, t3 = C.Color_AeS.name, i = 1; i <= t1; ++i) {
      ...
      if (t6 >= t5.length)
        throw H.ioore(t5, t6);
      J.set$fillStyle$x(t4, t5[t6].unlocked ? t3 : t2);
      t4 = $.ctx;
      t7 = $.get$HALFW();
      if (typeof t7 !== "number")
        throw t7.$sub();
      ...
      if (typeof t9 !== "number")
        throw t9.$sub();
      J.fillRect$4$x(t4, t7 - 60 + t8, t9 - 60, 40, 40);
      t9 = $.ctx;
      t4 = this.stage;
      if (t6 >= t4.length)
        throw H.ioore(t4, t6);
      J.set$fillStyle$x(t9, t4[t6].unlocked ? "#e1e1e1" : "#aaa");
      t5 = $.ctx;
      t7 = "STAGE " + i;
      t9 = $.get$HALFW();
      if (typeof t9 !== "number")
        throw t9.$sub();
      J.fillText$3$x(t5, t7, t9 - 70 + t8, $.get$HALFH());
    }
    t1 = $.util;
    t2 = $.get$HALFW();
    t3 = $.get$HALFH();
...
Level: {"": "Object;startPositions,level1,arena,litLvlName,bgColor,isCutscene",
  ...
  drawBg$0: function() {
    ...
    if (t3 >>> 0 !== t3 || t3 >= t2.length)
      throw H.ioore(t2, t3);
    J.set$fillStyle$x(t1, t2[t3]);
    J.fillRect$4$x($.ctx, 0, 0, $.FULLW, $.FULLH);
    this.litLvlName = "LEVEL " + H.S($.curLvl);
    J.set$font$x($.ctx, "18px 'Press Start 2P'");
    J.set$fillStyle$x($.ctx, "#000");
    t3 = $.ctx;
    t2 = this.litLvlName;
    t1 = $.get$HALFW();
    t4 = J.measureText$1$x($.ctx, this.litLvlName).width;
    if (typeof t4 !== "number")
      throw t4.$div();
    if (typeof t1 !== "number")
      throw t1.$sub();
    J.fillText$3$x(t3, t2, t1 - t4 / 2 + 2, 34);
    J.set$fillStyle$x($.ctx, "#e1e1e1");
    t4 = $.ctx;
    t1 = this.litLvlName;
    t2 = $.get$HALFW();
    t3 = J.measureText$1$x($.ctx, this.litLvlName).width;
    if (typeof t3 !== "number")
      throw t3.$div();
    if (typeof t2 !== "number")
      throw t2.$sub();
    J.fillText$3$x(t4, t1, t2 - t3 / 2, 32);
  },
  Level$0: function() {
...
Level_1: {"": "Object;wise,fish,dialog,underground,transitionOver",
  ...
  drawInstruction$1: function(str) {
    J.set$font$x($.ctx, "8px 'Press Start 2P'");
    J.set$fillStyle$x($.ctx, "#ccc");
    J.fillText$3$x($.ctx, str, 10, $.FULLH - 10);
  },
  ...
  canvasTransition$0: function() {
    ...
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.Level_1_canvasTransition_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    $.canvasListener = t2;
  },
  drawCutscene$0: function() {
    ...
    if (t1.movLocked) {
      ...
      if (!t2.usable) {
        t1 = $.util;
        t2 = this.wise;
        t1.blinkText$3(10, t2.x + 160, t2.y + 25);
      } else {
        t3 = t1.x;
        t4 = t1.w;
        if (typeof t4 !== "number")
        ...
        if (typeof t6 !== "number")
          throw H.iae(t6);
        t2.drawD$3(t3 + t4 / 2 - t5 / 2, t1 - t6 - 4, t2.imgU);
        t2 = $.util;
        t6 = $.p;
        t2.blinkText$3(10, t6.x + 160, t6.y + 25);
      }
    } else {
      t1 = t1.device;
      if (!t1.usable)
  ...
  drawWiseMan$0: function() {
    var t1, t2, t3, t4;
    this.wise.draw$0();
    J.set$font$x($.ctx, "11px 'Press Start 2P'");
    t1 = this.dialog;
    t2 = $.ctx;
    t3 = t1.dialog;
    t4 = t1.dialogLine;
    if (t4 < 0 || t4 >= 5)
      throw H.ioore(t3, t4);
    t1.dialogW = J.measureText$1$x(t2, t3[t4]).width;
    J.set$fillStyle$x($.ctx, "#000");
    t4 = $.ctx;
    t3 = this.wise;
    t2 = t3.x;
    t3 = t3.y;
    t1 = this.dialog.dialogW;
    if (typeof t1 !== "number")
      throw t1.$add();
    J.fillRect$4$x(t4, t2 + 24, t3 - 48, t1 + 7, 42);
    J.set$fillStyle$x($.ctx, "#e1e1e1");
    t1 = $.ctx;
    t3 = this.wise;
    t2 = t3.x;
    ...
    if (typeof t4 !== "number")
      throw t4.$add();
    J.fillRect$4$x(t1, t2 + 20, t3 - 53.5, t4 + 7, 42);
    J.set$fillStyle$x($.ctx, "#000");
    t4 = $.ctx;
    t3 = this.dialog;
    t2 = t3.dialog;
    ...
    t3 = t2[t3];
    t2 = this.wise;
    J.fillText$3$x(t4, t3, t2.x + 24, t2.y - 25);
  },
  Level_1$0: function() {
    var t1, t2;
...
Overworld: {"": "Object;lvlArr,ovrCurLvl,fixX,fixY,boxW,boxH,boxPadBot",
  update$0: function() {
    ...
    if (t2) {
      ...
      t1.toString;
      t1 = C._CustomEventStreamProvider__determineTransitionEventType.forElement$1(t1);
      t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.Overworld_update_closure(this)), t1._useCapture);
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t2._tryResume$0();
      $.canvasListener = t2;
    }
  ...
  transition$1: function(_, dir) {
    ...
    if (t2) {
      ...
      if (t1 < 0 || t1 >= t3.length)
        throw H.ioore(t3, t1);
      t2.x = t3[t1].x + this.fixX;
      t1 = this.lvlArr;
      t3 = this.ovrCurLvl;
      if (t3 >>> 0 !== t3 || t3 >= t1.length)
        throw H.ioore(t1, t3);
      t2.y = t1[t3].y + this.fixY;
    } else if (t1 === 1)
      if (dir === 37) {
        t2 = $.p;
        t3 = this.lvlArr;
  ...
  reset$0: function(_) {
    ...
    if (t1.lastKeyDown === 13) {
      ...
      if (t2 >= t1.length)
        throw H.ioore(t1, t2);
      t3.x = t1[t2].x + this.fixX;
      t1 = this.lvlArr;
      if (t2 >= t1.length)
        throw H.ioore(t1, t2);
      t3.y = t1[t2].y + this.fixY;
      this.ovrCurLvl = t2;
      t3.dir = 40;
      t3.invisible = false;
      $.lvlSelected = false;
  ...
  render$0: function() {
    var t1, t2, t3, i, lvlName, t4, t5, t6;
    J.set$fillStyle$x($.ctx, C.Color_axY.name);
    J.fillRect$4$x($.ctx, 0, 0, $.FULLW, $.FULLH);
    J.set$font$x($.ctx, "18px 'Press Start 2P'");
    J.set$fillStyle$x($.ctx, "#000");
    t1 = $.ctx;
    t2 = $.get$HALFW();
    t3 = J.measureText$1$x($.ctx, "TOWN OF DUNGEON").width;
    if (typeof t3 !== "number")
      throw t3.$div();
    if (typeof t2 !== "number")
      throw t2.$sub();
    J.fillText$3$x(t1, "TOWN OF DUNGEON", t2 - t3 / 2 + 2, 32);
    J.set$fillStyle$x($.ctx, "#e1e1e1");
    t3 = $.ctx;
    t2 = $.get$HALFW();
    t1 = J.measureText$1$x($.ctx, "TOWN OF DUNGEON").width;
    if (typeof t1 !== "number")
      throw t1.$div();
    if (typeof t2 !== "number")
      throw t2.$sub();
    J.fillText$3$x(t3, "TOWN OF DUNGEON", t2 - t1 / 2, 30);
    for (i = 0; i < $.NUM_LVLS; ++i) {
      ...
      if (i >= t1.length)
        throw H.ioore(t1, i);
      t1 = t1[i];
      lvlName = t1.unlocked || i === 0 ? t1.name : "UNKNOWN";
      t2 = $.ctx;
      t1 = t1.x;
      t3 = J.getInterceptor$x(t2).measureText$1(t2, lvlName).width;
      if (typeof t3 !== "number")
        throw t3.$div();
      t4 = this.lvlArr;
      if (i >= t4.length)
        throw H.ioore(t4, i);
      C.CanvasRenderingContext2D_methods.fillText$3(t2, lvlName, t1 - t3 / 14, t4[i].y + this.boxPadBot);
      if (i !== $.NUM_LVLS - 1) {
        t1 = $.ctx;
        if (i !== 0) {
          t2 = this.lvlArr;
          ...
          t2 = true;
        J.set$strokeStyle$x(t1, t2 ? "#ae7446" : "#222");
        J.set$lineWidth$x($.ctx, 3);
        J.beginPath$0$x($.ctx);
        t1 = $.ctx;
        t3 = this.lvlArr;
        if (i >= t3.length)
          throw H.ioore(t3, i);
        t3 = t3[i];
        J.moveTo$2$x(t1, t3.x + this.boxW, t3.y + this.boxH / 2);
        t1 = this.lvlArr;
        t2 = t1.length;
        if (i >= t2)
          throw H.ioore(t1, i);
        ...
        t6 = $.ctx;
        if (t3 === t2)
          J.lineTo$2$x(t6, t1, t2 + t5 / 2);
        else {
          J.lineTo$2$x(t6, t1 + this.boxW / 2, t3 + t5 / 2);
          t1 = $.ctx;
          t2 = this.lvlArr;
          t3 = t2.length;
          if (t4 >= t3)
          ...
          if (i >= t3)
            throw H.ioore(t2, i);
          J.moveTo$2$x(t1, t5 + t6 / 2, t2[i].y + this.boxH / 2);
          t2 = $.ctx;
          t6 = this.lvlArr;
          if (t4 >= t6.length)
            throw H.ioore(t6, t4);
          t4 = t6[t4];
          J.lineTo$2$x(t2, t4.x + this.boxW / 2, t4.y + this.boxH / 2);
        }
        J.stroke$0$x($.ctx);
        J.closePath$0$x($.ctx);
      }
      ...
      if (i >= t2.length)
        throw H.ioore(t2, i);
      J.set$fillStyle$x(t1, t2[i].color);
      t1 = this.lvlArr;
      if (i >= t1.length)
        throw H.ioore(t1, i);
      t1 = t1[i];
      if (t1.unlocked && !t1.beaten) {
        t1 = $.get$stairs();
        t2 = this.lvlArr;
        if (i >= t2.length)
          throw H.ioore(t2, i);
        ...
        J.fillRect$4$x($.ctx, t1.x, t1.y, this.boxW, this.boxH);
      t1 = this.lvlArr;
      if (i >= t1.length)
        throw H.ioore(t1, i);
      if (t1[i].beaten) {
        J.set$strokeStyle$x($.ctx, "#111");
        J.set$lineWidth$x($.ctx, 3);
        J.beginPath$0$x($.ctx);
        t1 = $.ctx;
        t2 = this.lvlArr;
        if (i >= t2.length)
          throw H.ioore(t2, i);
        t2 = t2[i];
        J.moveTo$2$x(t1, t2.x + 1, t2.y + 1);
        t2 = $.ctx;
        t1 = this.lvlArr;
        if (i >= t1.length)
          throw H.ioore(t1, i);
        t1 = t1[i];
        J.lineTo$2$x(t2, t1.x + this.boxW - 1, t1.y + this.boxH - 1);
        t1 = $.ctx;
        t2 = this.lvlArr;
        if (i >= t2.length)
          throw H.ioore(t2, i);
        t2 = t2[i];
        J.moveTo$2$x(t1, t2.x + 1, t2.y + this.boxH - 1);
        t2 = $.ctx;
        t1 = this.lvlArr;
        if (i >= t1.length)
          throw H.ioore(t1, i);
        t1 = t1[i];
        J.lineTo$2$x(t2, t1.x + this.boxW - 1, t1.y + 1);
        J.stroke$0$x($.ctx);
        J.closePath$0$x($.ctx);
      }
    }
...
StartScreen: {"": "Object;isOptions,linkClicked,ret,ent,OPEN_GAME,OPEN_START,mouse,newGame,linkColor,mouseMoveE,mouseClickE",
  ...
  drawTitle$0: function() {
    var tmpW, t1, titleW;
    J.set$font$x($.ctx, "43px 'Press Start 2P'");
    tmpW = J.measureText$1$x($.ctx, "DUNGEON").width;
    t1 = $.get$HALFW();
    ...
    if (typeof t1 !== "number")
      throw t1.$sub();
    titleW = t1 - tmpW / 2;
    J.set$fillStyle$x($.ctx, "rgb(21, 21, 21)");
    J.fillText$3$x($.ctx, "DUNGEON", titleW + 3, 84);
    J.set$fillStyle$x($.ctx, "rgb(192, 0, 0)");
    J.fillText$3$x($.ctx, "DUNGEON", titleW, 80);
  },
  ...
  get$startScreenLoop: function() {
    return new H.BoundClosure$1(this, F.StartScreen.prototype.startScreenLoop$1, null, "startScreenLoop$1");
  },
  ...
  drawStartScreen$0: function() {
    ...
    if (typeof t3 !== "number")
      throw t3.$sub();
    J.fillRect$4$x(t1, t2 - 108, t3 - 25, 228, 40);
    t3 = $.util;
    t2 = $.get$HALFW();
    t1 = $.get$HALFH();
    if (typeof t1 !== "number")
    ...
    J.set$font$x($.ctx, "7px 'Press Start 2P'");
    J.set$fillStyle$x($.ctx, "rgb(213, 213, 213)");
    t3 = $.ctx;
    t2 = $.get$HALFW();
    t1 = J.measureText$1$x($.ctx, "W,A,S,D OR ARROW MOVEMENT").width;
    if (typeof t1 !== "number")
      throw t1.$div();
    if (typeof t2 !== "number")
      throw t2.$sub();
    J.fillText$3$x(t3, "W,A,S,D OR ARROW MOVEMENT", t2 - t1 / 2, $.FULLH - 62);
    J.set$font$x($.ctx, "13px 'Press Start 2P'");
    J.set$fillStyle$x($.ctx, "rgb(233, 233, 233)");
    t1 = $.ctx;
    t2 = $.get$HALFW();
    t3 = J.measureText$1$x($.ctx, "\u00a9 2013 JON WIEDMANN").width;
    if (typeof t3 !== "number")
      throw t3.$div();
    if (typeof t2 !== "number")
      throw t2.$sub();
    J.fillText$3$x(t1, "\u00a9 2013 JON WIEDMANN", t2 - t3 / 2, $.FULLH - 24);
    this.drawTitle$0();
  },
  ...
  get$homeScreenLoop: function() {
    return new H.BoundClosure$1(this, F.StartScreen.prototype.homeScreenLoop$1, null, "homeScreenLoop$1");
  },
  ...
  drawHomeScreen$0: function() {
    ...
    t1 = $.ctx;
    t2 = $.get$HALFW();
    t3 = J.measureText$1$x($.ctx, "PRESS 'ENTER' TO START").width;
    if (typeof t3 !== "number")
      throw t3.$div();
    if (typeof t2 !== "number")
      throw t2.$sub();
    J.fillText$3$x(t1, "PRESS 'ENTER' TO START", t2 - t3 / 2, 372);
    J.set$font$x($.ctx, "15px 'Press Start 2P'");
    J.set$fillStyle$x($.ctx, this.linkColor);
    t3 = $.ctx;
    t2 = this.newGame;
    J.fillText$3$x(t3, this.ent, t2.x, t2.y + t2.h);
    J.set$font$x($.ctx, "15px 'Press Start 2P'");
    J.set$fillStyle$x($.ctx, "rgb(163, 163, 163)");
    t2 = $.ctx;
    t3 = $.get$HALFW();
    t1 = J.measureText$1$x($.ctx, "LOAD GAME").width;
    if (typeof t1 !== "number")
      throw t1.$div();
    if (typeof t3 !== "number")
      throw t3.$sub();
    J.fillText$3$x(t2, "LOAD GAME", t3 - t1 / 2, 232);
    J.set$font$x($.ctx, "13px 'Press Start 2P'");
    J.set$fillStyle$x($.ctx, "rgb(213, 213, 213)");
    t1 = $.ctx;
    t3 = $.get$HALFW();
    t2 = J.measureText$1$x($.ctx, "PRESS 'o' FOR OPTIONS").width;
    if (typeof t2 !== "number")
      throw t2.$div();
    if (typeof t3 !== "number")
      throw t3.$sub();
    J.fillText$3$x(t1, "PRESS 'o' FOR OPTIONS", t3 - t2 / 2, 407);
    t2 = $.ctx;
    t3 = this.ret;
    t1 = $.get$HALFW();
    t4 = J.measureText$1$x($.ctx, t3).width;
    if (typeof t4 !== "number")
      throw t4.$div();
    if (typeof t1 !== "number")
      throw t1.$sub();
    J.fillText$3$x(t2, t3, t1 - t4 / 2, 442);
  },
  drawOptions$0: function() {
    var t1, t2, t3, t4;
    this.drawBg$1(C.Color_Yf3.name);
    this.drawTitle$0();
    J.set$font$x($.ctx, "19px 'Press Start 2P'");
    J.set$fillStyle$x($.ctx, "rgb(213, 213, 213)");
    t1 = $.ctx;
    t2 = $.get$HALFW();
    t3 = J.measureText$1$x($.ctx, "OPTIONS").width;
    if (typeof t3 !== "number")
      throw t3.$div();
    if (typeof t2 !== "number")
      throw t2.$sub();
    J.fillText$3$x(t1, "OPTIONS", t2 - t3 / 2, 122);
    J.set$font$x($.ctx, "14px 'Press Start 2P'");
    J.fillText$3$x($.ctx, "AUDIO ....................... OFF", 40, 222);
    J.fillText$3$x($.ctx, "RESOLUTION .................. 540p", 40, 262);
    J.set$font$x($.ctx, "13px 'Press Start 2P'");
    t3 = $.ctx;
    t2 = this.ret;
    t1 = $.get$HALFW();
    t4 = J.measureText$1$x($.ctx, t2).width;
    if (typeof t4 !== "number")
      throw t4.$div();
    if (typeof t1 !== "number")
      throw t1.$sub();
    J.fillText$3$x(t3, t2, t1 - t4 / 2, 442);
  },
  ...
  drawItem$1: function(obj) {
    ...
    switch (this.dir) {
      case 38:
        ...
        if (typeof t3 !== "number")
          throw t3.$div();
        obj.drawD$3(t1 + t2 / 2 - t3 / 2, this.y - 25, obj.imgU);
        break;
      case 40:
        t1 = this.x;
        t2 = this.w;
        ...
        if (typeof t5 !== "number")
          throw H.iae(t5);
        obj.drawD$3(t1 + t2 / 2 - t3 / 2, t4 + t5 + 22, obj.imgD);
        break;
      case 37:
        t1 = this.x;
        t2 = this.y;
        ...
        if (typeof t4 !== "number")
          throw H.iae(t4);
        obj.drawD$3(t1 - 12, t2 + t3 / 2 - t4, obj.imgL);
        break;
      case 39:
        t1 = this.x;
        t2 = this.w;
        ...
        if (typeof t5 !== "number")
          throw H.iae(t5);
        obj.drawD$3(t1 + t2 + 2, t3 + t4 / 2 - t5, obj.imgR);
        break;
      default:
    }
  },
...
Utils: {"": "Object;alpha,tmpW,textPos,fadeOut,slideOut,flashTxtDone",
  ...
  blinkText$4: function(fontSize, x, y, str) {
    ...
    if (typeof t2 !== "number")
      throw H.iae(t2);
    this.alpha = t1 + t2;
    J.set$font$x($.ctx, "" + fontSize + "px 'Press Start 2P'");
    this.tmpW = J.measureText$1$x($.ctx, str).width;
    J.set$fillStyle$x($.ctx, "rgba(233, 233, 233, " + H.S(this.alpha) + ")");
    t2 = $.ctx;
    t1 = this.tmpW;
    if (typeof t1 !== "number")
      throw t1.$div();
    if (typeof x !== "number")
      throw x.$sub();
    J.fillText$3$x(t2, str, x - t1 / 2, y);
  },
  ...
  flashText$2: function(fontSize, str) {
    ...
    J.set$font$x($.ctx, "" + fontSize + "px 'Press Start 2P'");
    strDimensions = J.measureText$1$x($.ctx, str);
    J.set$fillStyle$x($.ctx, "rgba(12, 12, 12, .5)");
    t1 = $.ctx;
    t2 = $.FULLW;
    t3 = strDimensions.width;
    if (typeof t3 !== "number")
      throw t3.$div();
    J.fillRect$4$x(t1, t2 / 2 - t3 / 2 - 8, tmpY - 18, t3 + 15, 25);
    J.set$fillStyle$x($.ctx, "#e1e1e1");
    t3 = $.ctx;
    t2 = $.FULLW;
    ...
    if (typeof t1 !== "number")
      throw t1.$div();
    J.fillText$3$x(t3, str, t2 / 2 - t1 / 2, tmpY);
    return false;
  },
  Utils$0: function() {
    this.alpha = 0;
...
init.globalFunctions.Element__determineTransitionEventType$closure = W.Element__determineTransitionEventType$closure = new P.Closure$1(W.Element__determineTransitionEventType, "Element__determineTransitionEventType$closure");
