...
$$.Bound__onPause__BufferingStreamSubscription = [P, {"": "BoundClosure;_self,_liblib2$_target,_receiver,_liblib2$_name",
  call$0: function() {
...
$$.Bound__onResume__BufferingStreamSubscription = [P, {"": "BoundClosure;_self,_liblib2$_target,_receiver,_liblib2$_name",
  call$0: function() {
    return this._liblib2$_target.call(this._self);
  },
  $is_void_: true
...
$$.Bound__onPause__ForwardingStreamSubscription = [P, {"": "BoundClosure;_self,_liblib2$_target,_receiver,_liblib2$_name",
  call$0: function() {
    return this._liblib2$_target.call(this._self);
  },
  $is_void_: true
...
$$.Bound__onResume__ForwardingStreamSubscription = [P, {"": "BoundClosure;_self,_liblib2$_target,_receiver,_liblib2$_name",
  call$0: function() {
    return this._liblib2$_target.call(this._self);
  },
  $is_void_: true
...
$$.BoundClosure$1 = [P, {"": "BoundClosure;_self,_liblib2$_target,_receiver,_liblib2$_name",
  call$1: function(p0) {
    return this._liblib2$_target.call(this._self, p0);
  }
}];

$$.Bound__handleDone__ForwardingStreamSubscription = [P, {"": "BoundClosure;_self,_liblib2$_target,_receiver,_liblib2$_name",
  call$0: function() {
    return this._liblib2$_target.call(this._self);
  },
  $is_void_: true
...
$$.Closure$_determineTransitionEventType = [W, {"": "Closure;call$1,$name"}];
...
_ConstantMapKeyIterable: {"": "IterableBase;_liblib2$_map",
  get$iterator: function(_) {
    return J.get$iterator$ax(this._liblib2$_map._keys);
  },
  $asIterableBase: null
},
...
AnchorElement: {"": "HtmlElement;href=,name=",
  toString$0: function(receiver) {
...
DeviceOrientationEvent: {"": "Event;", $isDeviceOrientationEvent: true},
...
InputElement: {"": "HtmlElement;height%,name=,src},value=,width%"},
...
TransitionEvent: {"": "Event;", $isTransitionEvent: true},
...
FEImageElement: {"": "SvgElement;height=,width=,href="},
...
FilterElement: {"": "SvgElement;height=,width=,href="},

ForeignObjectElement: {"": "GraphicsElement;height=,width="},

GraphicsElement: {"": "SvgElement;"},

ImageElement0: {"": "GraphicsElement;height=,width=,href="},

MaskElement: {"": "SvgElement;height=,width="},

PatternElement: {"": "SvgElement;height=,width=,href="},
...
UseElement: {"": "GraphicsElement;height=,width=,href="},
...
["dungeon", "dungeon.dart", , F, {
main: function() {
  var t1, t2;
  t1 = C.EventStreamProvider_load.forTarget$1(window);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new F.main_closure()), t1._useCapture);
...
Enemy: {"": "GameObj;initHealth,health,invincibleTimer,invincible,captured,imgCardReady,animate,cardSrc,name,imgCard,hdir,vdir,ix,iy,w,h,x,y,ready,img,src",
  ...
  drawHealth$0: function() {
    ...
    t1.fillRect(J.$sub$n(J.$add$ns(t2, t3 / 2), 1), J.$sub$n(this.y, 15), t4 + 2, 8.2);
    t3 = $.ctx;
    t3.fillStyle = "#777";
    t2 = this.x;
    t1 = this.w;
    if (t1 == null)
      throw t1.$div();
    t3.fillRect(J.$add$ns(t2, t1 / 2), J.$sub$n(this.y, 14), t4, 6);
    $.ctx.fillStyle = "red";
    for (i = 0; i < this.health; ++i) {
      ...
      if (t3 == null)
        throw t3.$div();
      t1.fillRect(J.$add$ns(J.$add$ns(t2, t3 / 2), 5 * i), J.$sub$n(this.y, 14), 5, 6);
    }
  },
  Enemy$8: function(initHealth, cardSrc, $name, ix, iy, w, h, src) {
    ...
    if (t1 != null) {
      ...
      J.set$src$x(this.imgCard, "img/" + t1);
      J.set$width$x(this.imgCard, 100);
      J.set$height$x(this.imgCard, 150);
      t1 = J.get$onLoad$x(this.imgCard);
      t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new F.Enemy_closure(this)), t1._useCapture);
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t2._tryResume$0();
    }
  },
...
Game: {"": "Object;fpsHolder,oldTime,fps,w,h,invRatio",
  resizeGame$0: function() {
    ...
    J.set$width$x($.cWrap.style, H.S(this.w) + "px");
    J.set$height$x($.cWrap.style, H.S(this.h) + "px");
    t1 = window.innerHeight;
    t2 = this.h;
    if (t1 == null)
      throw t1.$sub();
    if (typeof t2 !== "number")
      throw H.iae(t2);
    J.set$marginTop$x($.cWrap.style, H.S((t1 - t2) / 2) + "px");
  },
  ...
  Game$0: function() {
    ...
    J.set$width$x($.canvas, $.FULLW);
    J.set$height$x($.canvas, $.FULLH);
    ...
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new F.Game_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = C.EventStreamProvider_deviceorientation.forTarget$1(window);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._EventStreamSubscription__wrapZone(new F.Game_closure0(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
    $.key = F.Keyboard$();
    $.util = F.Utils$();
    $.p = F.Player$(0, 0, 28, 38, "sprites/player/playerDungeon.png");
    $.overworld = F.Overworld$();
    $.level = F.Level$();
    t1 = $.p;
    t2 = $.overworld;
    t3 = t2.lvlArr;
    ...
    if (t1 >>> 0 !== t1 || t1 >= t3.length)
      throw H.ioore(t3, t1);
    t2.y = J.$add$ns(t3[t1].y, t4.fixY);
    $.lvlSelected = $.DEBUG_LVL;
    if ($.DEBUG_LVL)
      $.overworld.initLevel$0();
    t1 = window;
    t2 = new F.StartScreen(false, false, "PRESS ESC TO RETURN", "NEW GAME", 1, 2, new F.Rect(-1, -1, 8, 8), null, "rgb(213, 213, 213)", null, null).get$startScreenLoop();
    C.Window_methods._ensureRequestAnimationFrame$0(t1);
    C.Window_methods._requestAnimationFrame$1(t1, t2);
  },
  static: {
Game$: function() {
  var t1 = new F.Game(null, null, null, null, null, null);
  t1.Game$0();
  return t1;
}}
...
GameObj: {"": "Object;ix,iy,w,h,x,y,ready,img,src",
  draw$1: function(sp) {
    ...
    if (this.src != null && this.ready) {
      ...
      t6 = this.w;
      if (sp != null)
        t2.drawImage(t1, sp.sx, sp.sy, t6, t5, t4, t3, t6, t5);
      else
        t2.drawImage(t1, t4, t3, t6, t5);
    } else {
      t1 = $.ctx;
      t1.fillStyle = "#444";
  ...
  GameObj$5: function(ix, iy, w, h, str) {
    ...
    if (this.src != null) {
      ...
      J.set$src$x(this.img, "img/" + this.src);
      J.set$width$x(this.img, this.w);
      J.set$height$x(this.img, this.h);
      t1 = J.get$onLoad$x(this.img);
      t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new F.GameObj_closure(this)), t1._useCapture);
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t2._tryResume$0();
    }
  },
...
GameObj$: function(ix, iy, w, h, str) {
  var t1 = new F.GameObj(ix, iy, w, h, null, null, null, null, null);
...
GameObj_closure: {"": "Closure;this_0",
  call$1: function(e) {
    this.this_0.ready = true;
  }
},

IntBool: {"": "Object;key,isDirectionKey"},

Keyboard: {"": "Object;_liblib3$_keys,lastKeyDown,lastKeyUp,lastDirDown,lastDirUp,theKey,r",
  ...
  Keyboard$0: function() {
    ...
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new F.Keyboard_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = C.EventStreamProvider_keyup.forTarget$1(window);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._EventStreamSubscription__wrapZone(new F.Keyboard_closure0(this)), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
  },
  static: {
Keyboard$: function() {
  var t1 = new F.Keyboard(P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSInt, J.JSInt), null, null, null, null, new F.IntBool(null, null), new F.IntBool(null, null));
  t1.Keyboard$0();
  return t1;
}}
...
Keyboard_closure: {"": "Closure;this_0",
  call$1: function(e) {
    ...
    t1.theKey = t1.convertWASD$1(t2.get$keyCode(e));
    t3 = t1._liblib3$_keys;
    if (!t3.containsKey$1(t1.theKey.key)) {
      t4 = t1.theKey;
      if (t4.isDirectionKey === true)
        t1.lastDirDown = t4.key;
      t1.lastKeyDown = t1.theKey.key;
      t3.$indexSet(t3, t1.theKey.key, t2.get$timeStamp(e));
    }
  }
},
...
Keyboard_closure0: {"": "Closure;this_1",
  call$1: function(e) {
    ...
    if (t2.isDirectionKey === true)
      t1.lastDirUp = t2.key;
    t1.lastKeyUp = t1.theKey.key;
    t2 = t1._liblib3$_keys;
    t2.remove$1(t2, t1.theKey.key);
  }
},

Stage: {"": "Object;unlocked,beaten", $isStage: true},
...
Arena: {"": "Object;curStage,numStages,animalSelected,stage,stageSelected",
  ...
  drawStage1$0: function() {
    ...
    t1 = $.ctx;
    t1.fillStyle = C.Color_Yf3.name;
    t2 = $.get$HALFW();
    if (typeof t2 !== "number")
      throw t2.$sub();
    t1.fillRect(t2 - 100, 70, $.get$HALFW(), $.get$HALFH());
  ...
  drawAnimalSelector$0: function() {
    ...
    if (typeof t2 !== "number")
      throw t2.$sub();
    t1.fillRect(t2 - 50, $.FULLH - 90, 155, 65);
    t2 = $.ctx;
    t2.font = "9px 'Press Start 2P'";
    t2.fillStyle = "#000";
    t1 = $.get$HALFW();
    if (typeof t1 !== "number")
      throw t1.$sub();
    t2.fillText("SELECT ANIMAL", t1 - 30, $.FULLH - 74);
    t1 = $.ctx;
    ...
    for (i = 0; i < len; ++i) {
      ...
      if (typeof t3 !== "number")
        throw t3.$sub();
      t1.fillText(t2, t3 - 42, $.FULLH - 58);
    }
  },
  drawStageSelector$0: function() {
    var t1, t2, t3, i, t4, t5, t6, t7, t8, t9;
    t1 = $.ctx;
    t1.fillStyle = "#444";
    t1.fillRect(0, 0, $.FULLW, $.FULLH);
    $.ctx.font = "9px 'Press Start 2P'";
    for (t1 = this.numStages, t2 = C.Color_Yf3.name, t3 = C.Color_AeS.name, i = 1; i <= t1; ++i) {
      t4 = $.ctx;
      t5 = this.stage;
      t6 = i - 1;
      if (t6 >= t5.length)
        throw H.ioore(t5, t6);
      t4.fillStyle = t5[t6].unlocked ? t3 : t2;
      t7 = $.get$HALFW();
      if (typeof t7 !== "number")
        throw t7.$sub();
      t8 = t6 * 90;
      ...
      if (typeof t9 !== "number")
        throw t9.$sub();
      t4.fillRect(t7 - 60 + t8, t9 - 60, 40, 40);
      t9 = $.ctx;
      t4 = this.stage;
      if (t6 >= t4.length)
        throw H.ioore(t4, t6);
      t9.fillStyle = t4[t6].unlocked ? "#e1e1e1" : "#aaa";
      t5 = "STAGE " + i;
      t7 = $.get$HALFW();
      if (typeof t7 !== "number")
        throw t7.$sub();
      t9.fillText(t5, t7 - 70 + t8, $.get$HALFH());
    }
    t1 = $.util;
    t2 = $.get$HALFW();
    t3 = $.get$HALFH();
    if (typeof t3 !== "number")
      throw t3.$sub();
    t1.blinkText$3(9, t2, t3 - 120);
  },
  Arena$0: function() {
    var t1, t2, i, t3;
    t1 = this.numStages;
    t2 = P.List_List(t1, F.Stage);
    H.setRuntimeTypeInfo(t2, [F.Stage]);
    this.stage = t2;
    for (t2 = this.stage, i = 0; t3 = t2.length, i < t1; ++i) {
      if (i >= t3)
        throw H.ioore(t2, i);
      t2[i] = new F.Stage(false, false);
    }
    if (0 >= t3)
      throw H.ioore(t2, 0);
    t2[0].unlocked = true;
    $.p.animal.push(F.Enemy$(5, "fishCard.png", "Fish", $.get$HALFW(), 90, 71, 40, "fish.png"));
    $.p.movLocked = true;
  },
  static: {
Arena$: function() {
  var t1 = new F.Arena(0, 3, -1, null, false);
  t1.Arena$0();
  return t1;
}}
...
startPos: {"": "Object;x,y,dir", $isstartPos: true},
...
Level: {"": "Object;startPositions,level1,arena,litLvlName,bgColor,isCutscene",
  ...
  drawBg$0: function() {
    ...
    this.litLvlName = "LEVEL " + H.S($.curLvl);
    t3 = $.ctx;
  ...
  Level$0: function() {
    ...
    t1 = P.List_List($.NUM_LVLS, F.startPos);
    H.setRuntimeTypeInfo(t1, [F.startPos]);
    this.startPositions = t1;
    t1 = P.List_List($.NUM_LVLS, J.JSString);
    H.setRuntimeTypeInfo(t1, [J.JSString]);
    this.bgColor = t1;
    for (t1 = $.NUM_LVLS, i = 0; i < t1; ++i) {
      t2 = this.startPositions;
      t3 = new F.startPos(null, null, null);
      t3.y = 0;
      t3.x = 0;
      t3.dir = 40;
      if (i >= t2.length)
    ...
    if (0 >= t3.length)
      throw H.ioore(t3, 0);
    t2 = J.$add$ns(t3[0].x, t2.boxW / 2);
    t3 = $.p.w;
    if (t3 == null)
      throw t3.$div();
    t1.x = J.$sub$n(t2, t3 / 2);
    ...
    if (t4 >>> 0 !== t4 || t4 >= t1.length)
      throw H.ioore(t1, t4);
    t3.y = J.$sub$n(J.$add$ns(t1[t4].y, t2.boxH / 2), $.p.h);
    t2 = this.startPositions;
    if (1 >= t2.length)
      throw H.ioore(t2, 1);
    t2 = t2[1];
  ...
  static: {
Level$: function() {
  var t1 = new F.Level(null, null, null, null, null, null);
  t1.Level$0();
  return t1;
}}
...
Level_1: {"": "Object;wise,fish,dialog,underground,transitionOver",
  ...
  canvasTransition$0: function() {
    ...
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new F.Level_1_canvasTransition_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    $.canvasListener = t2;
  },
  drawCutscene$0: function() {
    ...
    if (t1.movLocked) {
      t2 = t1.device;
      if (!t2.usable)
        $.util.blinkText$3(10, J.$add$ns(this.wise.x, 160), J.$add$ns(this.wise.y, 25));
      else {
        t3 = t1.x;
        t1 = t1.w;
        if (t1 == null)
        ...
        t3 = J.$sub$n(t1, t3 / 2);
        t1 = $.p;
        t2.drawD$3(t3, J.$sub$n(J.$sub$n(t1.y, t1.device.h), 4), $.p.device.imgU);
        $.util.blinkText$3(10, J.$add$ns($.p.x, 160), J.$add$ns($.p.y, 25));
      }
    } else {
      t1 = t1.device;
      if (!t1.usable)
  ...
  drawWiseMan$0: function() {
    ...
    t4 = $.ctx;
    t4.fillStyle = "#000";
    t3 = J.$add$ns(this.wise.x, 24);
    t1 = J.$sub$n(this.wise.y, 48);
    ...
    t2 = $.ctx;
    t2.fillStyle = "#e1e1e1";
    t1 = J.$add$ns(this.wise.x, 20);
    t3 = J.$sub$n(this.wise.y, 53.5);
    ...
    if (t3 < 0 || t3 >= 5)
      throw H.ioore(t1, t3);
    t4.fillText(t1[t3], J.$add$ns(this.wise.x, 24), J.$sub$n(this.wise.y, 25));
  },
  Level_1$0: function() {
    var t1, t2;
    this.dialog = F.Dialog$();
    t1 = $.get$HALFW();
    t2 = $.get$HALFH();
    if (typeof t2 !== "number")
      throw t2.$sub();
    this.wise = F.GameObj$(t1, t2 - 35, 30, 43, "wiseMan.png");
    this.fish = F.Enemy$(5, "fishCard.png", "Fish", $.get$HALFW(), 90, 71, 40, "fish.png");
  ...
  static: {
Level_1$: function() {
  var t1 = new F.Level_1(null, null, null, null, null);
  t1.Level_1$0();
  return t1;
}}
...
Level_1_canvasTransition_closure: {"": "Closure;this_0",
  call$1: function(e) {
    ...
    if (t2 == null)
      throw H.iae(t2);
    t3.y = t4 - t2 - 20;
    t2 = J.get$classes$x($.canvas);
    t2.remove$1(t2, "duringTransition");
    t2 = J.get$classes$x($.canvas);
    t2.add$1(t2, "preTransition");
    $.p.dir = 38;
    this.this_0.transitionOver = true;
  }
},

lvl_t: {"": "Object;unlocked,beaten,name,color,x,y", $islvl_t: true},
...
Overworld: {"": "Object;lvlArr,ovrCurLvl,fixX,fixY,boxW,boxH,boxPadBot",
  update$0: function() {
    ...
    if (t2) {
      ...
      t1.get$onTransitionEnd;
      t1 = C._CustomEventStreamProvider__determineTransitionEventType.forElement$1(t1);
      t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._EventStreamSubscription__wrapZone(new F.Overworld_update_closure(this)), t1._useCapture);
      H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
      t2._tryResume$0();
      $.canvasListener = t2;
    }
  ...
  transition$1: function(_, dir) {
    ...
    if (t2) {
      ...
      if (t1 >>> 0 !== t1 || t1 >= t3.length)
        throw H.ioore(t3, t1);
      t2.x = J.$add$ns(t3[t1].x, this.fixX);
      t1 = $.p;
      t3 = this.lvlArr;
      t2 = this.ovrCurLvl;
      if (t2 >>> 0 !== t2 || t2 >= t3.length)
        throw H.ioore(t3, t2);
      t1.y = J.$add$ns(t3[t2].y, this.fixY);
    } else if (t1 === 1)
      if (dir === 37) {
        t2 = $.p;
        t3 = this.lvlArr;
  ...
  reset$0: function(_) {
    ...
    if (t1.lastKeyDown === 13) {
      ...
      if (t2 >= t1.length)
        throw H.ioore(t1, t2);
      t3.x = J.$add$ns(t1[t2].x, this.fixX);
      t2 = $.p;
      t1 = this.lvlArr;
      t3 = $.curLvl;
      if (t3 >>> 0 !== t3 || t3 >= t1.length)
        throw H.ioore(t1, t3);
      t2.y = J.$add$ns(t1[t3].y, this.fixY);
  ...
  render$0: function() {
    ...
    for (i = 0; i < $.NUM_LVLS; ++i) {
      ...
      if (i >= t2.length)
        throw H.ioore(t2, i);
      t1.fillText(lvlName, t3, J.$add$ns(t2[i].y, this.boxPadBot));
      if (i !== $.NUM_LVLS - 1) {
        t1 = $.ctx;
        if (i !== 0) {
          t2 = this.lvlArr;
        ...
        if (i >= t3.length)
          throw H.ioore(t3, i);
        t3 = J.$add$ns(t3[i].x, this.boxW);
        t4 = this.lvlArr;
        if (i >= t4.length)
          throw H.ioore(t4, i);
        t1.moveTo(t3, J.$add$ns(t4[i].y, this.boxH / 2));
        t1 = this.lvlArr;
        t2 = t1.length;
        if (i >= t2)
          throw H.ioore(t1, i);
        ...
        if (t1) {
          if (t4 >= t2.length)
            throw H.ioore(t2, t4);
          t1 = t2[t4];
          t3.lineTo(t1.x, J.$add$ns(t1.y, this.boxH / 2));
        } else {
          if (t4 >= t2.length)
            throw H.ioore(t2, t4);
          t1 = J.$add$ns(t2[t4].x, this.boxW / 2);
          t2 = this.lvlArr;
          if (i >= t2.length)
            throw H.ioore(t2, i);
          t3.lineTo(t1, J.$add$ns(t2[i].y, this.boxH / 2));
          t2 = $.ctx;
          t1 = this.lvlArr;
          if (t4 >= t1.length)
            throw H.ioore(t1, t4);
          t1 = J.$add$ns(t1[t4].x, this.boxW / 2);
          t3 = this.lvlArr;
          if (i >= t3.length)
            throw H.ioore(t3, i);
          t2.moveTo(t1, J.$add$ns(t3[i].y, this.boxH / 2));
          t3 = $.ctx;
          t1 = this.lvlArr;
          if (t4 >= t1.length)
            throw H.ioore(t1, t4);
          ...
          if (t4 >= t2.length)
            throw H.ioore(t2, t4);
          t3.lineTo(t1, J.$add$ns(t2[t4].y, this.boxH / 2));
        }
        $.ctx.stroke();
        $.ctx.closePath();
      }
      ...
      if (t1[i].beaten) {
        ...
        if (i >= t2.length)
          throw H.ioore(t2, i);
        t2 = J.$add$ns(t2[i].x, 1);
        t3 = this.lvlArr;
        if (i >= t3.length)
          throw H.ioore(t3, i);
        t1.moveTo(t2, J.$add$ns(t3[i].y, 1));
        t3 = $.ctx;
        t2 = this.lvlArr;
        if (i >= t2.length)
          throw H.ioore(t2, i);
        t2 = J.$sub$n(J.$add$ns(t2[i].x, this.boxW), 1);
        t1 = this.lvlArr;
        if (i >= t1.length)
          throw H.ioore(t1, i);
        t3.lineTo(t2, J.$sub$n(J.$add$ns(t1[i].y, this.boxH), 1));
        t1 = $.ctx;
        t2 = this.lvlArr;
        if (i >= t2.length)
          throw H.ioore(t2, i);
        ...
        if (i >= t3.length)
          throw H.ioore(t3, i);
        t1.moveTo(t2, J.$sub$n(J.$add$ns(t3[i].y, this.boxH), 1));
        t3 = $.ctx;
        t2 = this.lvlArr;
        if (i >= t2.length)
          throw H.ioore(t2, i);
        ...
        if (i >= t1.length)
          throw H.ioore(t1, i);
        t3.lineTo(t2, J.$add$ns(t1[i].y, 1));
        $.ctx.stroke();
        $.ctx.closePath();
      }
    }
  ...
  Overworld$0: function() {
    ...
    if (t2 == null)
      throw H.iae(t2);
    this.fixY = t3 / 2 - t2;
    t2 = P.List_List($.NUM_LVLS, F.lvl_t);
    H.setRuntimeTypeInfo(t2, [F.lvl_t]);
    this.lvlArr = t2;
    for (t1 = $.NUM_LVLS, t2 = C.Color_Yf3.name, i = 0; t3 = this.lvlArr, i < t1; ++i) {
      t4 = new F.lvl_t(null, null, null, null, null, null);
      t4.color = t2;
      t4.unlocked = false;
      t4.beaten = false;
      t4.y = 0;
  ...
  static: {
Overworld$: function() {
  var t1 = new F.Overworld(null, null, null, null, null, null, null);
  t1.Overworld$0();
  return t1;
}}
...
Player: {"": "GameObj;vX,vY,maxVx,maxVy,maxV,health,maxHealth,invincibleTimer,atkDownTime,atkUpTime,prevDir,dir,movLocked,invincible,invisible,heart,device,sword,animal,imgD,imgL,imgR,imgU,imgPicked,ix,iy,w,h,x,y,ready,img,src",
  update$0: function() {
    ...
    if (!this.movLocked) {
      ...
      if ($.key._liblib3$_keys.containsKey$1(32))
        ;
      t1 = this.sword;
      t1.inUse = t1.usable && $.key._liblib3$_keys.containsKey$1(32) && true;
      t1 = this.device;
      t1.inUse = t1.usable && $.key._liblib3$_keys.containsKey$1(16) && true;
    }
  },
  updatePosition$0: function() {
    ...
    if (Math.abs(this.vY) < 0.5)
      this.vY = 0;
    if (!tooFastY) {
      if ($.key._liblib3$_keys.containsKey$1(38)) {
        this.vY = this.vY - 1;
        this.dir = 38;
      }
      if ($.key._liblib3$_keys.containsKey$1(40)) {
        this.vY = this.vY + 1;
        this.dir = 40;
      }
    }
    if (!tooFastX) {
      if ($.key._liblib3$_keys.containsKey$1(37)) {
        this.vX = this.vX - 1;
        this.dir = 37;
      }
      if ($.key._liblib3$_keys.containsKey$1(39)) {
        this.vX = this.vX + 1;
        this.dir = 39;
      }
    }
    if (!($.key._liblib3$_keys.containsKey$1(38) && $.key._liblib3$_keys.containsKey$1(37)))
      if (!($.key._liblib3$_keys.containsKey$1(38) && $.key._liblib3$_keys.containsKey$1(39)))
        if (!($.key._liblib3$_keys.containsKey$1(40) && $.key._liblib3$_keys.containsKey$1(37)))
          t1 = $.key._liblib3$_keys.containsKey$1(40) && $.key._liblib3$_keys.containsKey$1(39);
        else
          t1 = true;
      else
        t1 = true;
  ...
  drawPlayer$0: function() {
    ...
    switch (this.dir) {
      ...
      case 8:
        ...
        break;
      case 80:
        t1 = C.JSInt_methods.$mod(this.invincibleTimer, 6);
        t2 = $.ctx;
        if (t1 === 0)
          t2.fillStyle = "white";
        else
  ...
  drawItem$1: function(obj) {
    ...
    switch (this.dir) {
      case 38:
        ...
        if (t1 == null)
          throw t1.$div();
        obj.drawD$3(J.$sub$n(t2, t1 / 2), J.$sub$n(this.y, 25), obj.imgU);
        break;
      case 40:
        t1 = this.x;
        t2 = this.w;
        ...
        if (t1 == null)
          throw t1.$div();
        obj.drawD$3(J.$sub$n(t2, t1 / 2), J.$add$ns(J.$add$ns(this.y, obj.h), 22), obj.imgD);
        break;
      case 37:
        t1 = J.$sub$n(this.x, 12);
        t2 = this.y;
        t3 = this.h;
        if (t3 == null)
          throw t3.$div();
        obj.drawD$3(t1, J.$sub$n(J.$add$ns(t2, t3 / 2), obj.h), obj.imgL);
        break;
      case 39:
        t1 = J.$add$ns(J.$add$ns(this.x, this.w), 2);
        t2 = this.y;
        t3 = this.h;
        if (t3 == null)
          throw t3.$div();
        obj.drawD$3(t1, J.$sub$n(J.$add$ns(t2, t3 / 2), obj.h), obj.imgR);
        break;
      default:
    }
  },
  ...
  Player$5: function(ix, iy, w, h, str) {
    ...
    if (typeof t2 !== "number")
      throw t2.$add();
    t2 += 20;
    t3 = new F.Item(null, null, new F.SpritePos(2, 2), new F.SpritePos(2, 24), new F.SpritePos(2, 24), new F.SpritePos(2, 24), t1, t2, 14, 20, null, null, null, null, null);
    t3.GameObj$5(t1, t2, 14, 20, "sprites/items/device/device.png");
    t3.inUse = false;
    t3.usable = false;
    this.device = t3;
    t3 = new F.Item(null, null, new F.SpritePos(2, 2), new F.SpritePos(12, 2), new F.SpritePos(12, 2), new F.SpritePos(12, 2), 0, 0, 9, 20, null, null, null, null, null);
    t3.GameObj$5(0, 0, 9, 20, "sprites/items/sword/sword.png");
    t3.inUse = false;
    t3.usable = false;
    this.sword = t3;
    this.heart = F.GameObj$(0, 0, 9, 9, "heart.png");
  },
  static: {
Player$: function(ix, iy, w, h, str) {
  var t1 = P.List_List(null, F.Enemy);
  H.setRuntimeTypeInfo(t1, [F.Enemy]);
  t1 = new F.Player(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, t1, new F.SpritePos(2, 2), new F.SpritePos(32, 2), new F.SpritePos(32, 42), new F.SpritePos(32, 82), new F.SpritePos(62, 82), ix, iy, w, h, null, null, null, null, null);
  t1.GameObj$5(ix, iy, w, h, str);
...
StartScreen: {"": "Object;isOptions,linkClicked,ret,ent,OPEN_GAME,OPEN_START,mouse,newGame,linkColor,mouseMoveE,mouseClickE",
  ...
  get$startScreenLoop: function() {
    return new P.BoundClosure$1(this, F.StartScreen.prototype.startScreenLoop$1, null, "startScreenLoop$1");
  },
  startScreen$0: function() {
    if ($.key._liblib3$_keys.containsKey$1(13) || $.DEBUG_OVERWORLD || $.DEBUG_LVL) {
      $.key.lastKeyDown = 8;
      this.mouseEvents$0();
      return true;
    }
  ...
  drawStartScreen$0: function() {
    ...
    if (typeof t3 !== "number")
      throw t3.$sub();
    t1.fillRect(t2 - 108, t3 - 25, 228, 40);
    t3 = $.util;
    t2 = $.get$HALFW();
    t1 = $.get$HALFH();
    if (typeof t1 !== "number")
      throw t1.$sub();
    t3.blinkText$4(19, t2, t1 - 5, "ENTER COIN");
    t1 = $.util;
    t2 = $.get$HALFW();
    t3 = $.get$HALFH();
    if (typeof t3 !== "number")
      throw t3.$add();
    t1.blinkText$4(8, t2, t3 + 15, "(OR PRESS ENTER)");
    t3 = $.ctx;
    t3.font = "7px 'Press Start 2P'";
    t3.fillStyle = "rgb(213, 213, 213)";
    t2 = $.get$HALFW();
    t1 = $.ctx.measureText("W,A,S,D OR ARROW MOVEMENT").width;
    if (typeof t1 !== "number")
      throw t1.$div();
    if (typeof t2 !== "number")
      throw t2.$sub();
    t3.fillText("W,A,S,D OR ARROW MOVEMENT", t2 - t1 / 2, $.FULLH - 62);
    t1 = $.ctx;
    t1.font = "13px 'Press Start 2P'";
    t1.fillStyle = "rgb(233, 233, 233)";
    t2 = $.get$HALFW();
    t3 = $.ctx.measureText("\u00a9 2013 JON WIEDMANN").width;
    if (typeof t3 !== "number")
      throw t3.$div();
    if (typeof t2 !== "number")
      throw t2.$sub();
    t1.fillText("\u00a9 2013 JON WIEDMANN", t2 - t3 / 2, $.FULLH - 24);
    this.drawTitle$0();
  },
  ...
  get$homeScreenLoop: function() {
    return new P.BoundClosure$1(this, F.StartScreen.prototype.homeScreenLoop$1, null, "homeScreenLoop$1");
  },
...
Utils: {"": "Object;alpha,tmpW,textPos,fadeOut,slideOut,flashTxtDone",
  ...
  blinkText$4: function(fontSize, x, y, str) {
    ...
    $.ctx.fillStyle = "rgba(233, 233, 233, " + H.S(this.alpha) + ")";
    t2 = $.ctx;
    t1 = this.tmpW;
    if (typeof t1 !== "number")
      throw t1.$div();
    t2.fillText(str, J.$sub$n(x, t1 / 2), y);
  },
  ...
  static: {
Utils$: function() {
  var t1 = new F.Utils(null, null, null, null, null, null);
  t1.Utils$0();
  return t1;
}}
...
Dialog: {"": "Object;dialogW,dialogLine,dialog",
  Dialog$0: function() {
    this.dialogLine = 0;
    this.dialogW = 0;
    var t1 = P.List_List(5, J.JSString);
    H.setRuntimeTypeInfo(t1, [J.JSString]);
    this.dialog = t1;
    t1 = this.dialog;
  ...
  static: {
Dialog$: function() {
  var t1 = new F.Dialog(null, null, null);
  t1.Dialog$0();
  return t1;
}}
...
init.globalFunctions.Element__determineTransitionEventType$closure = W.Element__determineTransitionEventType$closure = new W.Closure$_determineTransitionEventType(W.Element__determineTransitionEventType, "Element__determineTransitionEventType$closure");
...
F.Stage.$isObject = true;
F.startPos.$isObject = true;
F.lvl_t.$isObject = true;
F.Enemy.$isObject = true;
...
C.Color_AeS = new F.Color("#efce9b");
...
Isolate.$lazy($, "stairs", "stairs", "get$stairs", function() {
  return F.GameObj$(0, 0, 40, 40, "stairsR.png");
});
// Native classes
H.defineNativeMethods("CanvasGradient|CanvasPattern|CanvasRenderingContext|CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|TextMetrics", J.Interceptor);
...
function dart_precompiled($collectedClasses) {
  ...
  function _ConstantMapKeyIterable(_liblib2$_map) {
  ...
  function Bound__onPause__BufferingStreamSubscription(_self, _liblib2$_target, _receiver, _liblib2$_name) {
    this._self = _self;
    this._liblib2$_target = _liblib2$_target;
    this._receiver = _receiver;
    this._liblib2$_name = _liblib2$_name;
  ...
  function Bound__onResume__BufferingStreamSubscription(_self, _liblib2$_target, _receiver, _liblib2$_name) {
    this._self = _self;
    this._liblib2$_target = _liblib2$_target;
    this._receiver = _receiver;
    this._liblib2$_name = _liblib2$_name;
  ...
  function Bound__onPause__ForwardingStreamSubscription(_self, _liblib2$_target, _receiver, _liblib2$_name) {
    this._self = _self;
    this._liblib2$_target = _liblib2$_target;
    this._receiver = _receiver;
    this._liblib2$_name = _liblib2$_name;
  ...
  function Bound__onResume__ForwardingStreamSubscription(_self, _liblib2$_target, _receiver, _liblib2$_name) {
    this._self = _self;
    this._liblib2$_target = _liblib2$_target;
    this._receiver = _receiver;
    this._liblib2$_name = _liblib2$_name;
  ...
  function BoundClosure$1(_self, _liblib2$_target, _receiver, _liblib2$_name) {
    this._self = _self;
    this._liblib2$_target = _liblib2$_target;
    this._receiver = _receiver;
    this._liblib2$_name = _liblib2$_name;
  ...
  function Bound__handleDone__ForwardingStreamSubscription(_self, _liblib2$_target, _receiver, _liblib2$_name) {
    this._self = _self;
    this._liblib2$_target = _liblib2$_target;
    this._receiver = _receiver;
    this._liblib2$_name = _liblib2$_name;
  ...
  function _CustomizedZone(parent, _specification, _liblib5$_map) {
    this.parent = parent;
  ...
  function _AttributeClassSet(_liblib4$_element) {
  ...
  function Enemy_closure(this_0) {
    this.this_0 = this_0;
  }
  Enemy_closure.builtin$cls = "Enemy_closure";
  if (!"name" in Enemy_closure)
    Enemy_closure.name = "Enemy_closure";
  $desc = $collectedClasses.Enemy_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Enemy_closure.prototype = $desc;
  function Game(fpsHolder, oldTime, fps, w, h, invRatio) {
  ...
  function Game_closure0(this_1) {
    this.this_1 = this_1;
  }
  Game_closure0.builtin$cls = "Game_closure0";
  if (!"name" in Game_closure0)
    Game_closure0.name = "Game_closure0";
  $desc = $collectedClasses.Game_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_closure0.prototype = $desc;
  function GameObj(ix, iy, w, h, x, y, ready, img, src) {
    this.ix = ix;
    this.iy = iy;
    this.w = w;
    this.h = h;
  ...
  GameObj.builtin$cls = "GameObj";
  if (!"name" in GameObj)
    GameObj.name = "GameObj";
  $desc = $collectedClasses.GameObj;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GameObj.prototype = $desc;
  function GameObj_closure(this_0) {
    this.this_0 = this_0;
  }
  GameObj_closure.builtin$cls = "GameObj_closure";
  if (!"name" in GameObj_closure)
    GameObj_closure.name = "GameObj_closure";
  $desc = $collectedClasses.GameObj_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GameObj_closure.prototype = $desc;
  function IntBool(key, isDirectionKey) {
    this.key = key;
    this.isDirectionKey = isDirectionKey;
  }
  IntBool.builtin$cls = "IntBool";
  if (!"name" in IntBool)
    IntBool.name = "IntBool";
  $desc = $collectedClasses.IntBool;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IntBool.prototype = $desc;
  function Keyboard(_liblib3$_keys, lastKeyDown, lastKeyUp, lastDirDown, lastDirUp, theKey, r) {
    this._liblib3$_keys = _liblib3$_keys;
    this.lastKeyDown = lastKeyDown;
    this.lastKeyUp = lastKeyUp;
    this.lastDirDown = lastDirDown;
    this.lastDirUp = lastDirUp;
    this.theKey = theKey;
    this.r = r;
  }
  ...
  function Stage(unlocked, beaten) {
  ...
  function Arena(curStage, numStages, animalSelected, stage, stageSelected) {
  ...
  Arena.builtin$cls = "Arena";
  if (!"name" in Arena)
    Arena.name = "Arena";
  $desc = $collectedClasses.Arena;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Arena.prototype = $desc;
  function startPos(x, y, dir) {
    this.x = x;
    this.y = y;
    this.dir = dir;
  }
  startPos.builtin$cls = "startPos";
  if (!"name" in startPos)
    startPos.name = "startPos";
  $desc = $collectedClasses.startPos;
  if ($desc instanceof Array)
    $desc = $desc[1];
  startPos.prototype = $desc;
  function Level(startPositions, level1, arena, litLvlName, bgColor, isCutscene) {
    this.startPositions = startPositions;
    this.level1 = level1;
    this.arena = arena;
    this.litLvlName = litLvlName;
  ...
  function Level_1(wise, fish, dialog, underground, transitionOver) {
    this.wise = wise;
    this.fish = fish;
    this.dialog = dialog;
    this.underground = underground;
    this.transitionOver = transitionOver;
  }
  Level_1.builtin$cls = "Level_1";
  if (!"name" in Level_1)
    Level_1.name = "Level_1";
  $desc = $collectedClasses.Level_1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Level_1.prototype = $desc;
  function Level_1_canvasTransition_closure(this_0) {
    this.this_0 = this_0;
  }
  Level_1_canvasTransition_closure.builtin$cls = "Level_1_canvasTransition_closure";
  if (!"name" in Level_1_canvasTransition_closure)
    Level_1_canvasTransition_closure.name = "Level_1_canvasTransition_closure";
  $desc = $collectedClasses.Level_1_canvasTransition_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Level_1_canvasTransition_closure.prototype = $desc;
  function lvl_t(unlocked, beaten, name, color, x, y) {
    this.unlocked = unlocked;
    this.beaten = beaten;
    this.name = name;
    this.color = color;
  ...
  lvl_t.builtin$cls = "lvl_t";
  if (!"name" in lvl_t)
    lvl_t.name = "lvl_t";
  $desc = $collectedClasses.lvl_t;
  if ($desc instanceof Array)
    $desc = $desc[1];
  lvl_t.prototype = $desc;
  function Overworld(lvlArr, ovrCurLvl, fixX, fixY, boxW, boxH, boxPadBot) {
    this.lvlArr = lvlArr;
    this.ovrCurLvl = ovrCurLvl;
    this.fixX = fixX;
    this.fixY = fixY;
    this.boxW = boxW;
    this.boxH = boxH;
    this.boxPadBot = boxPadBot;
  }
  Overworld.builtin$cls = "Overworld";
  if (!"name" in Overworld)
    Overworld.name = "Overworld";
  $desc = $collectedClasses.Overworld;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Overworld.prototype = $desc;
  function Overworld_update_closure(this_0) {
    this.this_0 = this_0;
  }
  Overworld_update_closure.builtin$cls = "Overworld_update_closure";
  if (!"name" in Overworld_update_closure)
    Overworld_update_closure.name = "Overworld_update_closure";
  $desc = $collectedClasses.Overworld_update_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Overworld_update_closure.prototype = $desc;
  function Player(vX, vY, maxVx, maxVy, maxV, health, maxHealth, invincibleTimer, atkDownTime, atkUpTime, prevDir, dir, movLocked, invincible, invisible, heart, device, sword, animal, imgD, imgL, imgR, imgU, imgPicked, ix, iy, w, h, x, y, ready, img, src) {
    this.vX = vX;
    this.vY = vY;
    this.maxVx = maxVx;
    this.maxVy = maxVy;
    ...
    this.invincibleTimer = invincibleTimer;
    this.atkDownTime = atkDownTime;
    this.atkUpTime = atkUpTime;
    this.prevDir = prevDir;
    this.dir = dir;
    this.movLocked = movLocked;
    this.invincible = invincible;
  ...
  function Item(usable, inUse, imgD, imgL, imgR, imgU, ix, iy, w, h, x, y, ready, img, src) {
    this.usable = usable;
    this.inUse = inUse;
    this.imgD = imgD;
    this.imgL = imgL;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Item.prototype = $desc;
  function StartScreen(isOptions, linkClicked, ret, ent, OPEN_GAME, OPEN_START, mouse, newGame, linkColor, mouseMoveE, mouseClickE) {
    ...
    this.mouseMoveE = mouseMoveE;
    this.mouseClickE = mouseClickE;
  }
  StartScreen.builtin$cls = "StartScreen";
  if (!"name" in StartScreen)
    StartScreen.name = "StartScreen";
  $desc = $collectedClasses.StartScreen;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StartScreen.prototype = $desc;
  function Utils(alpha, tmpW, textPos, fadeOut, slideOut, flashTxtDone) {
    this.alpha = alpha;
    this.tmpW = tmpW;
    this.textPos = textPos;
    this.fadeOut = fadeOut;
    this.slideOut = slideOut;
    this.flashTxtDone = flashTxtDone;
  }
  Utils.builtin$cls = "Utils";
  if (!"name" in Utils)
    Utils.name = "Utils";
  $desc = $collectedClasses.Utils;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Utils.prototype = $desc;
  function Color(name) {
    this.name = name;
  }
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Rect.prototype = $desc;
  function SpritePos(sx, sy) {
    this.sx = sx;
    this.sy = sy;
  }
  SpritePos.builtin$cls = "SpritePos";
  if (!"name" in SpritePos)
    SpritePos.name = "SpritePos";
  $desc = $collectedClasses.SpritePos;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SpritePos.prototype = $desc;
  function Dialog(dialogW, dialogLine, dialog) {
    this.dialogW = dialogW;
    this.dialogLine = dialogLine;
    this.dialog = dialog;
  }
  Dialog.builtin$cls = "Dialog";
  if (!"name" in Dialog)
    Dialog.name = "Dialog";
  $desc = $collectedClasses.Dialog;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Dialog.prototype = $desc;
  ...
  function Closure$_determineTransitionEventType(call$1, $name) {
    this.call$1 = call$1;
    this.$name = $name;
  }
  Closure$_determineTransitionEventType.builtin$cls = "Closure$_determineTransitionEventType";
  $desc = $collectedClasses.Closure$_determineTransitionEventType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Closure$_determineTransitionEventType.prototype = $desc;
