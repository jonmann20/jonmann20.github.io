...
$isvs:true,
$isb8:true,
static:{"^":"Gn,Ry,C3,Cd,NK",Dt:function(a){return H.VM(new P.vs(0,$.X3,null,null,null,null,null,null),[a])},k3:function(a,b){b.Gv=2
...
T9:[function(a){return J.v1(a)},"call$1","rm",2,0,2],
...
z=this.H9
y=this.zN
for(;z!=null;){b.call$2(z.gkh(),z.KI)
...
return"transitionend"},"call$1","ZK",2,0,5],
...
Gc:{
"^":"Y5;ku:fillStyle},EJ:font},Lm:strokeStyle}",
...
skx:function(a,b){this.Mg(a,"margin-top",b,"")},
...
return}throw "Unable to print message: " + String(a)}}],["dungeon","dungeon.dart",,F,{
"^":"",
Iq:[function(){var z=C.fK.aM(window)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.em()),z.Sg),[H.Kp(z,0)]).Zz()},"call$0","KW",0,0,0],
em:{
"^":"Tp:8;",
call$1:function(a){$.Rc=F.vd()}},
iJ:{
"^":"LH;Uu,M3,b0,CU,mC,EW,Vl,vu,tV,u5,oc,zL,fC,ei,ES,bK,x,y,aS,Xi,LA",
...
w=this.M3*5
z.fillRect(y+x/2-1,this.y-15,w+2,8.2)
x=$.Ee
J.yc(x,"#777")
y=this.x
z=this.ES
if(typeof z!=="number")return z.V()
x.fillRect(y+z/2,this.y-14,w,6)
J.yc($.Ee,"red")
for(v=0;v<this.b0;++v){z=$.Ee
y=this.x
x=this.ES
if(typeof x!=="number")return x.V()
J.HM(z,y+x/2+5*v,this.y-14,5,6)}},
...
this.mC=0
z=this.u5
if(z!=null){y=W.jm(null,null,null)
this.zL=y
J.Yj(y,"img/"+H.d(z))
J.vP(this.zL,100)
J.OE(this.zL,150)
z=J.wK(this.zL)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.cj(this)),z.Sg),[H.Kp(z,0)]).Zz()}},
static:{fY:function(a,b,c,d,e,f,g,h){var z=new F.iJ(0.9,a,null,null,null,null,null,null,null,b,c,null,d,e,f,g,null,null,null,null,null)
z.aB(d,e,f,g,h)
z.BU(a,b,c,d,e,f,g,h)
return z}}},
cj:{
"^":"Tp:8;a",
call$1:function(a){this.a.vu=!0}},
fq:{
"^":"a;zX,tO,rM,ES,bK,FU",
Tn:function(){var z,y,x,w,v,u
z=window.innerWidth
if(typeof z!=="number")return z.D()
z=z>1120?1120:window.innerWidth
this.ES=z
y=window.innerHeight
if(typeof y!=="number")return y.D()
y=y>630?630:window.innerHeight
this.bK=y
x=$.ld
if(typeof z!=="number")return z.V()
w=z/x
...
this.FU=1/u
J.vP($.AE.style,""+y+"px")
J.OE($.AE.style,H.d(this.bK)+"px")
y=window.innerHeight
z=this.bK
if(typeof y!=="number")return y.W()
if(typeof z!=="number")return H.s(z)
J.wP($.AE.style,H.d((y-z)/2)+"px")},
V6:[function(a){var z,y,x,w,v,u,t,s,r,q,p,o
this.HR(a,this.tO)
if($.Bp!==!0||$.ul===0)$.ks.mF()
else{z=$.OR
z.toString
switch($.ul){case 1:y=z.ZO
y.toString
if(z.cO){x=$.G3
if(x.wh===13){y=y.kv
w=y.c5
...
y.Dx=!0
z.w8=8}}else{z=y.a4
if(z.Vl);else if(!y.QU){if($.CS.Sd($.qk,$.An(),12)){y.QU=!0
y.Jo()}}else{if(z.b0>0){if($.CS.Sd($.qk,z,3)){z=$.qk
if(!z.EW){z.b0=z.b0-1
z.EW=!0
z.Qe=-z.Qe*1.3
z.rV=-z.rV*1.3
...
if(x>y)z.y=y+z.Uu
else if(x<y)z.y=y-z.Uu}}}if(z.mC>250)z.mC=0
y=$.qk.eP
if(y.PG&&$.CS.Tx(y,z))if(!z.EW){z.b0=z.b0-1
z.EW=!0}}}break
case 2:z=z.MU
y=z.GD
if(!y&&$.G3.wh===13){$.G3.kJ()
...
if(typeof x!=="number")return H.s(x)
z.y=y-x-20
z.w8=38}else if(y){y=$.G3
if(y.wh===13){z.G5=0
y.kJ()}}break}z=$.qk
if(z.b0<=0){window.alert("You Died")
z.rV=0
z.Qe=0
z.GO=!0
z.b0=1
J.fR(C.ol.gmW(window),J.qG(C.ol.gmW(window)))}if(z.EW){y=z.CU-1
z.CU=y
if(y<0){z.EW=!1
z.CU=50
z.w8=z.Ld}}if(!z.GO){v=Math.abs(z.rV)>z.r3&&!0
u=Math.abs(z.Qe)>z.Mm&&!0
t=Math.abs(z.Qe)+Math.abs(z.rV)>z.Rs&&!0
y=z.rV
if(y>0)z.rV=y-0.5
else if(y<0)z.rV=y+0.5
y=z.Qe
if(y>0){y-=0.5
z.Qe=y}else if(y<0){y+=0.5
z.Qe=y}if(Math.abs(y)<0.5)z.Qe=0
if(Math.abs(z.rV)<0.5)z.rV=0
if(!v){if($.G3.Rn.x4(38)){z.rV=z.rV-1
z.w8=38}if($.G3.Rn.x4(40)){z.rV=z.rV+1
z.w8=40}}if(!u){if($.G3.Rn.x4(37)){z.Qe=z.Qe-1
z.w8=37}if($.G3.Rn.x4(39)){z.Qe=z.Qe+1
z.w8=39}}if(!($.G3.Rn.x4(38)&&$.G3.Rn.x4(37)))if(!($.G3.Rn.x4(38)&&$.G3.Rn.x4(39)))if(!($.G3.Rn.x4(40)&&$.G3.Rn.x4(37)))y=$.G3.Rn.x4(40)&&$.G3.Rn.x4(39)
else y=!0
else y=!0
else y=!0
if(y){z.w8=$.G3.xo
...
x=y-x
if(s>x)z.x=x
else z.x=w+(s-w)}if(q<0)z.y=0
else{y=$.yJ
x=z.bK
if(typeof x!=="number")return H.s(x)
x=y-x
if(q>x)z.y=x
else z.y=r+(q-r)}if($.G3.Rn.x4(32));y=z.eP
y.PG=y.Dx&&$.G3.Rn.x4(32)&&!0
z=z.IF
z.PG=z.Dx&&$.G3.Rn.x4(16)&&!0}}if($.Bp!==!0||$.ul===0)$.ks.AD()
else{z=$.OR
z.toString
y=$.ul
switch(y){case 1:x=z.ZO
x.toString
w=$.Ee
z=z.Xm
...
J.yc(w,H.d(z[y]))
J.HM($.Ee,0,0,$.ld,$.yJ)
if($.OR.cO){if(!$.qk.IF.Dx){x.oW.T1()
z=$.Ee
J.Yd(z,"11px 'Press Start 2P'")
y=x.kv
w=y.kv
r=y.c5
if(r>=5)return H.e(w,r)
y.I1=z.measureText(w[r]).width
r=$.Ee
J.yc(r,"#000")
w=x.oW
z=w.x
...
w=z[w]
z=x.oW
C.Tr.lR(r,w,z.x+24,z.y-25)}z=$.qk
if(z.GO){y=z.IF
if(!y.Dx){z=$.CS
x=x.oW
z.Oa(10,x.x+160,x.y+25)}else{x=z.x
w=z.ES
...
y.pS(x+w/2-r/2,z-p-4,y.Ne)
y=$.CS
p=$.qk
y.Oa(10,p.x+160,p.y+25)}}else{z=z.IF
if(!z.Dx)z.W2(z.Ne)}}else if(!x.vW)$.An().Bt($.ld-60,70)
else if($.CS.Re(11,"FIGHT")){z=$.qk
z.GO=!1
y=x.a4
if(!y.Vl){y.T1()
x.a4.J1()
z=x.a4
if(z.b0>0){x.PL="USE SPACEBAR"
z.tV=!0}else{x.PL="USE SHIFT"
z.tV=!1}}else if(y.b0<=0){if(y.vu){x=$.OR.Xm
...
case 2:z=z.MU
if(!z.GD)z.Gu()
else switch(z.SJ){case 0:y=$.Ee
J.yc(y,"#111")
y.fillRect(0,0,$.ld,$.yJ)
y=$.Ee
J.yc(y,C.ZU.oc)
x=$.HT()
if(typeof x!=="number")return x.W()
y.fillRect(x-100,70,x,$.mk())
y=z.G5
if(y!==-1){z=$.qk.dh
x=z.length
...
if(typeof y!=="number")return y.V()
if(typeof r!=="number")return r.W()
w.Bt(r-y/2,$.yJ-120)}else z.ek()
z=$.Ee
J.yc(z,"orange")
z.fillRect($.ld-250,20,35,35)
break}break}z=$.qk
if(!z.kA){z.rl()
y=z.eP
if(y.PG)z.JL(y)
y=z.IF
if(y.PG)z.JL(y)}if(!$.OR.cO){$.ov().MQ()
z=$.OR.ZO
if(z.PL!=null){y=$.Ee
J.RE(y).sEJ(y,"8px 'Press Start 2P'")
y.fillStyle="#ccc"
C.Tr.lR(y,z.PL,10,$.yJ-10)}}}z=window
y=this.gjp()
C.ol.hr(z)
C.ol.oB(z,W.VF(y))},"call$1","gjp",2,0,18],
HR:function(a,b){var z,y
z=J.Wx(a)
y=z.W(a,b)
if(typeof y!=="number")return y.V()
$.JK=y/1000
if(C.jn.Y(z.yu(a),12)===0){z=$.JK
if(typeof z!=="number")return H.s(z)
z=C.jn.Z(1,z)
this.rM=z
this.zX.textContent="Dungeon: "+H.d(z)+" fps"}this.tO=a},
UM:function(){var z,y,x,w
z=document.querySelector(".canvasWrap")
$.AE=z
...
y.sR(z,$.ld)
y.sfg(z,$.yJ)
this.zX=document.querySelector("title")
$.ul=0
this.rM=0
this.tO=0
$.JK=0
this.Tn()
z=C.IU.aM(window)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.li(this)),z.Sg),[H.Kp(z,0)]).Zz()
z=C.TM.aM(window)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.MB(this)),z.Sg),[H.Kp(z,0)]).Zz()
$.G3=F.wM()
z=new F.US(null,null,null,null,null,null)
z.Ul()
$.CS=z
z=new F.nK(null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,H.VM([],[F.iJ]),new F.Tw(2,2),new F.Tw(32,2),new F.Tw(32,42),new F.Tw(32,82),new F.Tw(62,82),0,0,28,38,null,null,null,null,null)
z.aB(0,0,28,38,"sprites/player/playerDungeon.png")
z.a5(0,0,28,38,"sprites/player/playerDungeon.png")
$.qk=z
$.ks=F.IG()
$.OR=F.mu()
z=$.qk
...
if(w)y.z2()
z=window
y=new F.jT(!1,!1,"PRESS ESC TO RETURN","NEW GAME",1,2,new F.PY(-1,-1,8,8),null,"rgb(213, 213, 213)",null,null).gf9()
C.ol.hr(z)
C.ol.oB(z,W.VF(y))},
static:{vd:function(){var z=new F.fq(null,null,null,null,null,null)
z.UM()
return z}}},
li:{
"^":"Tp:8;a",
call$1:function(a){this.a.Tn()}},
MB:{
"^":"Tp:8;b",
call$1:function(a){this.b.Tn()}},
LH:{
"^":"a;fC,ei,ES,bK,x,y,aS,Xi,LA",
W2:function(a){var z,y,x,w,v,u
if(this.LA!=null&&this.aS){z=this.Xi
y=$.Ee
x=this.bK
w=this.ES
v=this.y
u=this.x
if(a!=null)J.QY(y,z,a.yx,a.TQ,w,x,u,v,w,x)
else J.cb(y,z,u,v,w,x)}else{z=$.Ee
J.yc(z,"#444")
z.fillRect(this.x,this.y,this.ES,this.bK)}},
T1:function(){return this.W2(null)},
pS:function(a,b,c){this.x=a
this.y=b
if(c!=null)this.W2(c)
else this.T1()},
Bt:function(a,b){return this.pS(a,b,null)},
...
this.Xi=z
J.Yj(z,"img/"+H.d(this.LA))
J.vP(this.Xi,this.ES)
J.OE(this.Xi,this.bK)
z=J.wK(this.Xi)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.Zt(this)),z.Sg),[H.Kp(z,0)]).Zz()},
static:{UC:function(a,b,c,d,e){var z=new F.LH(a,b,c,d,null,null,null,null,null)
z.aB(a,b,c,d,e)
return z}}},
Zt:{
"^":"Tp:8;a",
call$1:function(a){this.a.aS=!0}},
P1:{
"^":"a;G3,R0"},
U8:{
"^":"a;Rn,wh,QW,xo,eK,hK,r",
Pm:function(a){var z=this.r
z.G3=a
z.R0=!0
switch(a){case 87:case 38:z.G3=38
break
case 65:case 37:z.G3=37
break
case 83:case 40:z.G3=40
break
case 68:case 39:z.G3=39
break
default:z.R0=!1
break}return z},
kJ:function(){this.eK=8
this.xo=8
this.QW=8
this.wh=8},
kS:function(){this.kJ()
var z=C.rl.aM(window)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.ln(this)),z.Sg),[H.Kp(z,0)]).Zz()
z=C.Z4.aM(window)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.Ft(this)),z.Sg),[H.Kp(z,0)]).Zz()},
static:{wM:function(){var z=new F.U8(P.L5(null,null,null,J.im,J.im),null,null,null,null,new F.P1(null,null),new F.P1(null,null))
z.kS()
return z}}},
ln:{
"^":"Tp:19;a",
...
z="LEVEL "+H.d($.ul)
y=$.Ee
J.RE(y).sEJ(y,"18px 'Press Start 2P'")
y.fillStyle="#000"
x=$.HT()
w=J.cq($.Ee,z).width
if(typeof w!=="number")return w.V()
if(typeof x!=="number")return x.W()
C.Tr.lR(y,z,x-w/2+2,34)
w=$.Ee
J.RE(w).sku(w,"#e1e1e1")
x=$.HT()
y=J.cq($.Ee,z).width
if(typeof y!=="number")return y.V()
if(typeof x!=="number")return x.W()
C.Tr.lR(w,z,x-y/2,32)
for(v=0;v<$.qk.b0;++v){y=this.S4
y.x=8+13*v
y.y=8
y.T1()}}},
Lz:{
...
y=$.HT()
if(typeof y!=="number")return y.W()
z.fillRect(y-50,$.yJ-90,155,65)
y=$.Ee
J.RE(y).sEJ(y,"9px 'Press Start 2P'")
y.fillStyle="#000"
z=$.HT()
if(typeof z!=="number")return z.W()
C.Tr.lR(y,"SELECT ANIMAL",z-30,$.yJ-74)
z=$.Ee
J.Yd(z,"8px 'Press Start 2P'")
z.fillStyle="#333"
x=$.qk.dh.length
for(w=0;w<x;++w){z=$.Ee
y=$.qk.dh
...
J.mi(z,y,v-42,$.yJ-58)}},
Gu:function(){var z,y,x,w,v,u,t,s,r,q
z=$.Ee
J.yc(z,"#444")
z.fillRect(0,0,$.ld,$.yJ)
J.Yd($.Ee,"9px 'Press Start 2P'")
for(z=this.RP,y=C.ZU.oc,x=C.DK.oc,w=1;w<=z;++w){v=$.Ee
u=this.DA
t=w-1
...
y=H.VM(Array(z),[F.Lz])
this.DA=y
for(x=0;x<z;++x){if(x>=y.length)return H.e(y,x)
y[x]=new F.Lz(!1,!1)}if(0>=y.length)return H.e(y,0)
y[0].B7=!0
$.qk.dh.push(F.fY(5,"fishCard.png","Fish",$.HT(),90,71,40,"fish.png"))
$.qk.GO=!0},
static:{vw:function(){var z=new F.zV(0,3,-1,null,!1)
z.bp()
return z}}},
Lf:{
"^":"a;x,y,w8"},
Ng:{
"^":"a;uN,ZO,MU,Xm,cO",
YO:function(){var z,y,x,w,v,u,t,s,r,q,p
this.cO=!0
this.uN=H.VM(Array($.f4),[F.Lf])
this.Xm=H.VM(Array($.f4),[J.O])
for(z=$.f4,y=0;y<z;++y){x=this.uN
w=new F.Lf(null,null,null)
w.y=0
w.x=0
w.w8=40
if(y>=x.length)return H.e(x,y)
x[y]=w}for(x=this.Xm,y=0;y<z;++y){if(y>=x.length)return H.e(x,y)
x[y]="#666"}z=this.uN
x=z.length
...
if(2>=x)return H.e(z,2)
v.w8=40},
static:{mu:function(){var z=new F.Ng(null,null,null,null,null)
z.YO()
return z}}},
bG:{
"^":"a;oW,a4,kv,QU,vW,PL",
Jo:function(){var z=$.qk
z.GO=!0
z.rV=0
z.Qe=0
J.pP($.qN).Rz(0,"preTransition")
J.pP($.qN).h(0,"duringTransition")
z=$.qN
z.toString
z=C.hi.f0(z)
z=H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.ix(this)),z.Sg),[H.Kp(z,0)])
z.Zz()
$.rP=z},
Xr:function(){var z,y
z=new F.qg(null,null,null)
z.nE()
this.kv=z
z=$.HT()
y=$.mk()
if(typeof y!=="number")return y.W()
this.oW=F.UC(z,y-35,30,43,"wiseMan.png")
this.a4=F.fY(5,"fishCard.png","Fish",$.HT(),90,71,40,"fish.png")
this.vW=!1
this.QU=!1
$.qk.GO=!0}},
ix:{
...
z.y=x-y-20
J.pP($.qN).Rz(0,"duringTransition")
J.pP($.qN).h(0,"preTransition")
$.qk.w8=38
this.a.vW=!0}},
Si:{
"^":"a;B7,pb,oc,ih,x,y"},
Dv:{
"^":"a;ZD,ab,rU,EA,WZ,LG,vt",
mF:function(){var z,y,x
switch($.G3.xo){case 38:break
case 40:break
case 37:this.PB(0,37)
break
case 39:this.PB(0,39)
break}z=$.G3
if(z.wh===13){y=this.ZD
x=this.ab
if(x>>>0!==x||x>=y.length)return H.e(y,x)
x=y[x]
y=x.B7&&!x.pb}else y=!1
if(y){z.kJ()
J.pP($.qN).Rz(0,"preTransition")
J.pP($.qN).h(0,"duringTransition")
z=$.qN
z.toString
z=C.hi.f0(z)
z=H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new F.Gi(this)),z.Sg),[H.Kp(z,0)])
z.Zz()
$.rP=z}},
...
z=$.Gx?$.U0:this.ab
$.ul=z
switch(z){case 0:break
case 1:z=$.OR
y=new F.bG(null,null,null,null,null,null)
y.Xr()
z.ZO=y
break
case 2:$.OR.MU=F.vw()
...
y.y=x[z].y+this.EA}else if(z===1)if(b===37){y=$.qk
x=this.ZD
...
y.x=x[z].x+this.rU
if(z>=w)return H.e(x,z)
y.y=x[z].y+this.EA}else{if(b===39){y=this.ZD
...
y.x=x[z].x+this.rU
if(z>=w)return H.e(x,z)
y.y=x[z].y+this.EA}}else if(z===2&&b===37){y=$.qk
x=this.ZD
if(typeof z!=="number")return z.W();--z
this.ab=z
w=x.length
...
y.x=x[z].x+this.rU
if(z>=w)return H.e(x,z)
y.y=x[z].y+this.EA}$.G3.kJ()},
AD:function(){var z,y,x,w,v,u,t,s
z=$.Ee
J.yc(z,C.CV.oc)
z.fillRect(0,0,$.ld,$.yJ)
z=$.Ee
J.RE(z).sEJ(z,"18px 'Press Start 2P'")
z.fillStyle="#000"
y=$.HT()
x=J.cq($.Ee,"TOWN OF DUNGEON").width
if(typeof x!=="number")return x.V()
if(typeof y!=="number")return y.W()
C.Tr.lR(z,"TOWN OF DUNGEON",y-x/2+2,32)
x=$.Ee
J.RE(x).sku(x,"#e1e1e1")
y=$.HT()
z=J.cq($.Ee,"TOWN OF DUNGEON").width
if(typeof z!=="number")return z.V()
if(typeof y!=="number")return y.W()
C.Tr.lR(x,"TOWN OF DUNGEON",y-z/2,30)
for(w=0;w<$.f4;++w){z=$.Ee
J.RE(z).sku(z,"#e1e1e1")
z.font="9px 'Press Start 2P'"
y=this.ZD
if(w>=y.length)return H.e(y,w)
y=y[w]
v=y.B7||w===0?y.oc:"UNKNOWN"
y=y.x
x=z.measureText(v).width
if(typeof x!=="number")return x.V()
u=this.ZD
if(w>=u.length)return H.e(u,w)
C.Tr.lR(z,v,y-x/14,u[w].y+this.vt)
if(w!==$.f4-1){z=$.Ee
if(w!==0){y=this.ZD
x=w-1
u=y.length
if(x<0||x>=u)return H.e(y,x)
if(!y[x].B7){if(w>=u)return H.e(y,w)
y=y[w].pb}else y=!0}else y=!0
J.bs(z,y?"#ae7446":"#222")
z.lineWidth=3
z.beginPath()
z=$.Ee
...
x=x[w]
J.zc(z,x.x+this.WZ,x.y+this.LG/2)
z=this.ZD
y=z.length
...
t=this.LG
s=$.Ee
if(x===y)J.IL(s,z.x,y+t/2)
else{J.IL(s,z.x+this.WZ/2,x+t/2)
z=$.Ee
y=this.ZD
x=y.length
...
J.zc(z,t+s/2,y[w].y+this.LG/2)
y=$.Ee
s=this.ZD
if(u>=s.length)return H.e(s,u)
u=s[u]
J.IL(y,u.x+this.WZ/2,u.y+this.LG/2)}J.po($.Ee)
J.Mq($.Ee)}z=$.Ee
y=this.ZD
if(w>=y.length)return H.e(y,w)
J.yc(z,y[w].ih)
...
z.x=y
z.y=u
z.T1()}else z.fillRect(u.x,u.y,this.WZ,this.LG)
z=this.ZD
...
if(w>=z.length)return H.e(z,w)
z=z[w]
J.IL(y,z.x+this.WZ-1,z.y+this.LG-1)
z=$.Ee
y=this.ZD
if(w>=y.length)return H.e(y,w)
y=y[w]
J.zc(z,y.x+1,y.y+this.LG-1)
y=$.Ee
z=this.ZD
if(w>=z.length)return H.e(z,w)
z=z[w]
J.IL(y,z.x+this.WZ-1,z.y+1)
J.po($.Ee)
J.Mq($.Ee)}}$.qk.rl()},
...
if(typeof z!=="number")return H.s(z)
this.EA=19-z
z=H.VM(Array($.f4),[F.Si])
this.ZD=z
for(y=$.f4,x=C.ZU.oc,w=0;w<y;++w){v=new F.Si(null,null,null,null,null,null)
v.ih=x
v.B7=!1
v.pb=!1
v.y=0
...
if(2>=y)return H.e(z,2)
u.ih="#555"},
static:{IG:function(){var z=new F.Dv(null,null,null,null,null,null,null)
z.WJ()
return z}}},
Gi:{
"^":"Tp:8;a",
call$1:function(a){J.pP($.qN).Rz(0,"duringTransition")
J.pP($.qN).h(0,"preTransition")
this.a.z2()}},
jT:{
"^":"a;OA,Ie,dD,ik,KC,fn,ad,Tc,mX,Hq,jg",
yf:function(a){var z=$.Ee
J.yc(z,a)
z.fillRect(0,0,$.ld,$.yJ)},
Vy:function(){return this.yf("#000")},
ak:function(){var z,y,x
z=$.Ee
J.Yd(z,"43px 'Press Start 2P'")
y=z.measureText("DUNGEON").width
z=$.HT()
if(typeof y!=="number")return y.V()
if(typeof z!=="number")return z.W()
x=z-y/2
z=$.Ee
J.RE(z).sku(z,"rgb(21, 21, 21)")
C.Tr.lR(z,"DUNGEON",x+3,84)
z=$.Ee
J.RE(z).sku(z,"rgb(192, 0, 0)")
C.Tr.lR(z,"DUNGEON",x,80)},
...
y=this.gAV()
C.ol.hr(z)
C.ol.oB(z,W.VF(y))}else{z=window
y=this.gf9()
C.ol.hr(z)
C.ol.oB(z,W.VF(y))}},"call$1","gf9",2,0,18],
xX:function(){var z,y,x
if($.G3.Rn.x4(13)||$.eE||$.Gx){$.G3.wh=8
z=$.HT()
if(typeof z!=="number")return z.W()
this.Tc=new F.PY(z-57,192,120,13)
return!0}this.Vy()
z=$.Ee
y=$.HT()
if(typeof y!=="number")return y.W()
x=$.mk()
if(typeof x!=="number")return x.W()
J.HM(z,y-108,x-25,228,40)
x=$.CS
y=$.HT()
z=$.mk()
if(typeof z!=="number")return z.W()
x.Zs(19,y,z-5,"ENTER COIN")
z=$.CS
y=$.HT()
x=$.mk()
if(typeof x!=="number")return x.g()
z.Zs(8,y,x+15,"(OR PRESS ENTER)")
x=$.Ee
J.RE(x).sEJ(x,"7px 'Press Start 2P'")
x.fillStyle="rgb(213, 213, 213)"
y=$.HT()
z=J.cq($.Ee,"W,A,S,D OR ARROW MOVEMENT").width
if(typeof z!=="number")return z.V()
if(typeof y!=="number")return y.W()
C.Tr.lR(x,"W,A,S,D OR ARROW MOVEMENT",y-z/2,$.yJ-62)
z=$.Ee
J.RE(z).sEJ(z,"13px 'Press Start 2P'")
z.fillStyle="rgb(233, 233, 233)"
y=$.HT()
x=J.cq($.Ee,"\u00a9 2013 JON WIEDMANN").width
if(typeof x!=="number")return x.V()
if(typeof y!=="number")return y.W()
C.Tr.lR(z,"\u00a9 2013 JON WIEDMANN",y-x/2,$.yJ-24)
this.ak()
return!1},
aq:[function(a){var z,y
z=$.Rc
z.HR(a,z.tO)
if(this.rF()===this.KC){z=window
y=$.Rc.gjp()
C.ol.hr(z)
C.ol.oB(z,W.VF(y))}else if(this.rF()===this.fn){z=window
y=this.gf9()
C.ol.hr(z)
C.ol.oB(z,W.VF(y))}else{z=window
y=this.gAV()
C.ol.hr(z)
C.ol.oB(z,W.VF(y))}},"call$1","gAV",2,0,18],
rF:function(){var z,y,x,w
if(this.OA){z=$.G3
if(z.wh===27){this.OA=!1
z.wh=8}this.yf(C.ZU.oc)
this.ak()
z=$.Ee
J.RE(z).sEJ(z,"19px 'Press Start 2P'")
z.fillStyle="rgb(213, 213, 213)"
y=$.HT()
x=J.cq($.Ee,"OPTIONS").width
if(typeof x!=="number")return x.V()
if(typeof y!=="number")return y.W()
C.Tr.lR(z,"OPTIONS",y-x/2,122)
x=$.Ee
J.RE(x).sEJ(x,"14px 'Press Start 2P'")
C.Tr.lR(x,"AUDIO ....................... OFF",40,222)
J.mi($.Ee,"RESOLUTION .................. 540p",40,262)
x=$.Ee
J.RE(x).sEJ(x,"13px 'Press Start 2P'")
y=this.dD
z=$.HT()
w=J.cq($.Ee,y).width
if(typeof w!=="number")return w.V()
if(typeof z!=="number")return z.W()
C.Tr.lR(x,y,z-w/2,442)}else{z=$.G3
y=z.wh
if(y===13||$.eE||$.Gx){z.xo=8
return this.KC}else if(y===79)this.OA=!0
else if(y===27)return this.fn
else{this.yf(C.ZU.oc)
this.ak()
z=$.Ee
J.RE(z).sEJ(z,"13px 'Press Start 2P'")
z.fillStyle="rgb(213, 213, 213)"
y=$.HT()
x=J.cq($.Ee,"PRESS 'ENTER' TO START").width
if(typeof x!=="number")return x.V()
if(typeof y!=="number")return y.W()
C.Tr.lR(z,"PRESS 'ENTER' TO START",y-x/2,372)
x=$.Ee
J.RE(x).sEJ(x,"15px 'Press Start 2P'")
x.fillStyle=this.mX
y=this.Tc
C.Tr.lR(x,this.ik,y.x,y.y+y.bK)
y=$.Ee
J.RE(y).sEJ(y,"15px 'Press Start 2P'")
y.fillStyle="rgb(163, 163, 163)"
x=$.HT()
z=J.cq($.Ee,"LOAD GAME").width
if(typeof z!=="number")return z.V()
if(typeof x!=="number")return x.W()
C.Tr.lR(y,"LOAD GAME",x-z/2,232)
z=$.Ee
J.RE(z).sEJ(z,"13px 'Press Start 2P'")
z.fillStyle="rgb(213, 213, 213)"
x=$.HT()
y=J.cq($.Ee,"PRESS 'o' FOR OPTIONS").width
if(typeof y!=="number")return y.V()
if(typeof x!=="number")return x.W()
C.Tr.lR(z,"PRESS 'o' FOR OPTIONS",x-y/2,407)
y=$.Ee
x=this.dD
z=$.HT()
w=J.cq(y,x).width
if(typeof w!=="number")return w.V()
if(typeof z!=="number")return z.W()
C.Tr.lR(y,x,z-w/2,442)}}return 0}},
nK:{
"^":"LH;Qe,rV,Mm,r3,Rs,b0,hV,CU,BG,Xq,Ld,w8,GO,EW,kA,IF,eP,dh,Dd,vX,VJ,Ne,TM,fC,ei,ES,bK,x,y,aS,Xi,LA",
rl:function(){var z,y
switch(this.w8){case 38:this.W2(this.Ne)
break
case 40:this.W2(this.Dd)
break
case 37:this.W2(this.vX)
break
case 39:this.W2(this.VJ)
break
case 8:this.W2(this.TM)
break
case 80:z=C.jn.Y(this.CU,6)
y=$.Ee
if(z===0)J.yc(y,"white")
else J.yc(y,"red")
J.HM($.Ee,this.x,this.y,this.ES,this.bK)
break}},
JL:function(a){var z,y,x,w,v
switch(this.w8){case 38:z=this.x
y=this.ES
if(typeof y!=="number")return y.V()
x=a.ES
if(typeof x!=="number")return x.V()
a.pS(z+y/2-x/2,this.y-25,a.Ne)
break
case 40:z=this.x
y=this.ES
if(typeof y!=="number")return y.V()
...
if(typeof y!=="number")return y.g()
y+=20
x=new F.VO(null,null,new F.Tw(2,2),new F.Tw(2,24),new F.Tw(2,24),new F.Tw(2,24),z,y,14,20,null,null,null,null,null)
x.aB(z,y,14,20,"sprites/items/device/device.png")
x.PG=!1
x.Dx=!1
this.IF=x
x=new F.VO(null,null,new F.Tw(2,2),new F.Tw(12,2),new F.Tw(12,2),new F.Tw(12,2),0,0,9,20,null,null,null,null,null)
x.aB(0,0,9,20,"sprites/items/sword/sword.png")
x.PG=!1
x.Dx=!1
this.eP=x}},
VO:{
"^":"LH;Dx,PG,Dd,vX,VJ,Ne,fC,ei,ES,bK,x,y,aS,Xi,LA"},
US:{
"^":"a;VR,Fm,VC,hq,DP,Pr",
...
if(z)return!0
return!1},
Tx:function(a,b){return this.Sd(a,b,0)},
Zs:function(a,b,c,d){var z,y,x
z=this.VR
if(z<=0)this.hq=!1
else if(z>1.55)this.hq=!0
y=this.hq
x=$.JK
if(y){if(typeof x!=="number")return x.J()
y=-x}else y=x
if(typeof y!=="number")return H.s(y)
this.VR=z+y
J.Yd($.Ee,""+a+"px 'Press Start 2P'")
this.Fm=J.cq($.Ee,d).width
J.yc($.Ee,"rgba(233, 233, 233, "+H.d(this.VR)+")")
y=$.Ee
z=this.Fm
if(typeof z!=="number")return z.V()
if(typeof b!=="number")return b.W()
J.mi(y,d,b-z/2,c)},
Oa:function(a,b,c){return this.Zs(a,b,c,"PRESS ENTER")},
...
y=this.DP
w=$.JK
if(y){if(typeof w!=="number")return w.J()
y=-w*120}else{if(typeof w!=="number")return w.U()
y=w*450}v=z+y
this.VC=v
x=v<x?x:v
J.Yd($.Ee,""+a+"px 'Press Start 2P'")
u=J.cq($.Ee,b)
z=$.Ee
J.yc(z,"rgba(12, 12, 12, .5)")
y=$.ld
w=u.width
if(typeof w!=="number")return w.V()
z.fillRect(y/2-w/2-8,x-18,w+15,25)
w=$.Ee
J.RE(w).sku(w,"#e1e1e1")
y=$.ld
z=u.width
if(typeof z!=="number")return z.V()
C.Tr.lR(w,b,y/2-z/2,x)
return!1},
Ul:function(){this.VR=0
this.Fm=0
this.VC=$.yJ
this.hq=!1
this.DP=!0}},
...
qg:{
"^":"a;I1,c5,kv",
nE:function(){this.c5=0
this.I1=0
var z=H.VM(Array(5),[J.O])
this.kv=z
z[0]="HELLO, I AM WISE MAN."
z[1]="WELCOME TO DUNGEON."
z[2]="I HAVE COME ACROSS"
z[3]="A WONDERFUL DEVICE!"
z[4]="YOU MAY HAVE IT."}}},1],["html_common","dart:html_common",,P,{
"^":"",
...
I.$lazy($,"HALFW","yw","HT",function(){return $.ld/2})
I.$lazy($,"HALFH","bq","mk",function(){return $.yJ/2})
I.$lazy($,"stairs","py","An",function(){return F.UC(0,0,40,40,"stairsR.png")})
I.$lazy($,"hud","zq","ov",function(){var z=new F.up(null)
z.S4=F.UC(0,0,9,9,"heart.png")
return z})

init.functionAliases={}
init.metadata=[{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"EC",ret:J.O,args:[W.D0]},{func:"NT"},{func:"bh",args:[null,null]},{func:"Dv",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"yV",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"ew",void:true,args:[J.P]},{func:"c0",args:[W.HL]},];$=null
...
;(function (callback) {
  ...
  if (typeof dartMainRunner === "function") {
    dartMainRunner((function(a){H.Rq(F.KW(),a)}), []);
  } else {
    (function(a){H.Rq(F.KW(),a)})([]);
  }
})
function init(){I.p={}
...
if($desc instanceof Array)$desc=$desc[1]
xZ.prototype=$desc
xZ.prototype.gLU=function(receiver){return receiver.href}
...
if($desc instanceof Array)$desc=$desc[1]
a1.prototype=$desc
function db(kh,KI,An,zQ){this.kh=kh
this.KI=KI
this.An=An
...
if($desc instanceof Array)$desc=$desc[1]
em.prototype=$desc
function iJ(Uu,M3,b0,CU,mC,EW,Vl,vu,tV,u5,oc,zL,fC,ei,ES,bK,x,y,aS,Xi,LA){this.Uu=Uu
this.M3=M3
this.b0=b0
this.CU=CU
this.mC=mC
...
if($desc instanceof Array)$desc=$desc[1]
cj.prototype=$desc
function fq(zX,tO,rM,ES,bK,FU){this.zX=zX
this.tO=tO
this.rM=rM
this.ES=ES
this.bK=bK
this.FU=FU}fq.builtin$cls="fq"
...
if($desc instanceof Array)$desc=$desc[1]
MB.prototype=$desc
function LH(fC,ei,ES,bK,x,y,aS,Xi,LA){this.fC=fC
this.ei=ei
this.ES=ES
this.bK=bK
this.x=x
...
if($desc instanceof Array)$desc=$desc[1]
Zt.prototype=$desc
function P1(G3,R0){this.G3=G3
this.R0=R0}P1.builtin$cls="P1"
if(!"name" in P1)P1.name="P1"
$desc=$collectedClasses.P1
if($desc instanceof Array)$desc=$desc[1]
P1.prototype=$desc
function U8(Rn,wh,QW,xo,eK,hK,r){this.Rn=Rn
this.wh=wh
this.QW=QW
this.xo=xo
this.eK=eK
this.hK=hK
this.r=r}U8.builtin$cls="U8"
if(!"name" in U8)U8.name="U8"
$desc=$collectedClasses.U8
if($desc instanceof Array)$desc=$desc[1]
U8.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
Ft.prototype=$desc
function up(S4){this.S4=S4}up.builtin$cls="up"
if(!"name" in up)up.name="up"
$desc=$collectedClasses.up
if($desc instanceof Array)$desc=$desc[1]
up.prototype=$desc
function Lz(B7,pb){this.B7=B7
this.pb=pb}Lz.builtin$cls="Lz"
if(!"name" in Lz)Lz.name="Lz"
$desc=$collectedClasses.Lz
if($desc instanceof Array)$desc=$desc[1]
Lz.prototype=$desc
function zV(SJ,RP,G5,DA,GD){this.SJ=SJ
this.RP=RP
this.G5=G5
this.DA=DA
this.GD=GD}zV.builtin$cls="zV"
if(!"name" in zV)zV.name="zV"
$desc=$collectedClasses.zV
if($desc instanceof Array)$desc=$desc[1]
zV.prototype=$desc
function Lf(x,y,w8){this.x=x
this.y=y
this.w8=w8}Lf.builtin$cls="Lf"
if(!"name" in Lf)Lf.name="Lf"
$desc=$collectedClasses.Lf
if($desc instanceof Array)$desc=$desc[1]
Lf.prototype=$desc
function Ng(uN,ZO,MU,Xm,cO){this.uN=uN
this.ZO=ZO
this.MU=MU
this.Xm=Xm
this.cO=cO}Ng.builtin$cls="Ng"
if(!"name" in Ng)Ng.name="Ng"
$desc=$collectedClasses.Ng
if($desc instanceof Array)$desc=$desc[1]
Ng.prototype=$desc
function bG(oW,a4,kv,QU,vW,PL){this.oW=oW
this.a4=a4
this.kv=kv
this.QU=QU
this.vW=vW
this.PL=PL}bG.builtin$cls="bG"
...
if($desc instanceof Array)$desc=$desc[1]
ix.prototype=$desc
function Si(B7,pb,oc,ih,x,y){this.B7=B7
this.pb=pb
this.oc=oc
this.ih=ih
this.x=x
this.y=y}Si.builtin$cls="Si"
if(!"name" in Si)Si.name="Si"
$desc=$collectedClasses.Si
if($desc instanceof Array)$desc=$desc[1]
Si.prototype=$desc
function Dv(ZD,ab,rU,EA,WZ,LG,vt){this.ZD=ZD
this.ab=ab
this.rU=rU
this.EA=EA
this.WZ=WZ
this.LG=LG
this.vt=vt}Dv.builtin$cls="Dv"
...
if($desc instanceof Array)$desc=$desc[1]
Gi.prototype=$desc
function jT(OA,Ie,dD,ik,KC,fn,ad,Tc,mX,Hq,jg){this.OA=OA
this.Ie=Ie
this.dD=dD
this.ik=ik
this.KC=KC
...
this.mX=mX
this.Hq=Hq
this.jg=jg}jT.builtin$cls="jT"
if(!"name" in jT)jT.name="jT"
$desc=$collectedClasses.jT
if($desc instanceof Array)$desc=$desc[1]
jT.prototype=$desc
function nK(Qe,rV,Mm,r3,Rs,b0,hV,CU,BG,Xq,Ld,w8,GO,EW,kA,IF,eP,dh,Dd,vX,VJ,Ne,TM,fC,ei,ES,bK,x,y,aS,Xi,LA){this.Qe=Qe
this.rV=rV
this.Mm=Mm
this.r3=r3
this.Rs=Rs
...
this.aS=aS
this.Xi=Xi
this.LA=LA}nK.builtin$cls="nK"
if(!"name" in nK)nK.name="nK"
$desc=$collectedClasses.nK
if($desc instanceof Array)$desc=$desc[1]
nK.prototype=$desc
function VO(Dx,PG,Dd,vX,VJ,Ne,fC,ei,ES,bK,x,y,aS,Xi,LA){this.Dx=Dx
this.PG=PG
this.Dd=Dd
this.vX=vX
this.VJ=VJ
...
this.aS=aS
this.Xi=Xi
this.LA=LA}VO.builtin$cls="VO"
if(!"name" in VO)VO.name="VO"
$desc=$collectedClasses.VO
if($desc instanceof Array)$desc=$desc[1]
VO.prototype=$desc
function US(VR,Fm,VC,hq,DP,Pr){this.VR=VR
this.Fm=Fm
this.VC=VC
this.hq=hq
this.DP=DP
this.Pr=Pr}US.builtin$cls="US"
if(!"name" in US)US.name="US"
$desc=$collectedClasses.US
if($desc instanceof Array)$desc=$desc[1]
US.prototype=$desc
function uH(oc){this.oc=oc}uH.builtin$cls="uH"
if(!"name" in uH)uH.name="uH"
$desc=$collectedClasses.uH
if($desc instanceof Array)$desc=$desc[1]
uH.prototype=$desc
function PY(x,y,ES,bK){this.x=x
this.y=y
this.ES=ES
this.bK=bK}PY.builtin$cls="PY"
if(!"name" in PY)PY.name="PY"
$desc=$collectedClasses.PY
if($desc instanceof Array)$desc=$desc[1]
PY.prototype=$desc
function Tw(yx,TQ){this.yx=yx
this.TQ=TQ}Tw.builtin$cls="Tw"
if(!"name" in Tw)Tw.name="Tw"
$desc=$collectedClasses.Tw
if($desc instanceof Array)$desc=$desc[1]
Tw.prototype=$desc
function qg(I1,c5,kv){this.I1=I1
this.c5=c5
this.kv=kv}qg.builtin$cls="qg"
...
if($desc instanceof Array)$desc=$desc[1]
GE.prototype=$desc
return[qE,Gh,hg,rK,xZ,Mr,lJ,ct,nB,i3,it,QP,IF,n6,Ny,Kh,TK,Y5,Gc,nx,QQ,fW,y4,d7,Um,oJ,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,hn,eP,A6,Og,u8,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,GS,Qb,PG,F3,xI,Aj,Q0,eY,KV,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,Lx,h4,UK,GI,Tb,Iv,BT,yY,kJ,FB,xV,e1,ZH,FH,y6,RH,Kn,Z2,w6,BR,r4,aG,J6,Oi,Xg,UM,hq,r0,yp,c1,JU,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,Pq,kx,nV,Zc,ui,D6,DQ,Sm,xL,QU,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,QN,N9,BA,d0,tp,rE,CC,PQ,uz,hB,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,fv,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,UD,ZD,vt,cu,BD,vR,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Jo,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,oU,cC,RA,IY,JH,jl,Vg,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,lc,v,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,SU,Ca,vs,da,pV,U7,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,lD,LG,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,AC,Z0,c8,a,mE,Rn,wv,BV,id,zL,ec,I4,Fk,RO,eu,xC,kG,Pb,W9,rB,O7,XY,b0,Pg,Ob,GV,em,iJ,cj,fq,li,MB,LH,Zt,P1,U8,ln,Ft,up,Lz,zV,Lf,Ng,bG,ix,Si,Dv,Gi,jT,nK,VO,US,uH,PY,Tw,qg,As,GE]}