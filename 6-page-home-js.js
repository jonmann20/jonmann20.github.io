(window.webpackJsonp=window.webpackJsonp||[]).push([[11,4,6,7],{11:function(t,e,n){"use strict";n.r(e);var o=n(23);let i;e.default=Object(o.b)(i||(i=(t=>t)`
	:host {
		display: block;
	}
...
`))},12:function(t,e,n){"use strict";n.r(e);var o=n(23);let i;e.default=Object(o.b)(i||(i=(t=>t)`
	.col-left ul {
		font-size: 1.15em;
	}
...
`))},13:function(t,e,n){"use strict";n.r(e),n.d(e,"BLACK",(function(){return i})),n.d(e,"BLUE",(function(){return r})),n.d(e,"RED",(function(){return a})),n.d(e,"WHITE",(function(){return d})),n.d(e,"YELLOW",(function(){return c}));const o=getComputedStyle(document.body),i=o.getPropertyValue("--black"),r=o.getPropertyValue("--blue"),a=o.getPropertyValue("--red"),d=o.getPropertyValue("--white"),c=o.getPropertyValue("--yellow")},18:function(t,e,n){"use strict";n.r(e);var o=n(23),i=n(11),r=n(12),a=n(24),d=n(13);let c,l,s=t=>t;class p extends o.a{constructor(){super(),document.title="Jon Wiedmann",a.a.addMeta("description","Jon Wiedmann's personal website.  A site with information on Jon's work experience and hobbies."),a.a.addMeta("keywords","Jon Wiedmann, Web Developer, HTML5, CSS, Javascript","Polymer"),a.a.addLink("preconnect","https://platform.twitter.com"),a.a.addLink("preconnect","https://cdn.syndication.twimg.com"),a.a.addLink("preconnect","https://syndication.twitter.com"),a.a.addLink("dns-prefetch","https://abs.twimg.com"),a.a.addLink("dns-prefetch","https://pbs.twimg.com"),a.a.addLink("dns-prefetch","https://ton.twimg.com")}firstUpdated(){a.a.require("https://platform.twitter.com/widgets.js").then(()=>{let t=document.createElement("style");t.type="text/css",t.innerHTML=`\n\t\t\t\tbody {\n\t\t\t\t\tcolor: ${d.WHITE};\n\t\t\t\t}\n\n\t\t\t\t.timeline-Widget {\n\t\t\t\t\tbackground: ${d.BLACK};\n\t\t\t\t}\n\n\t\t\t\t.customisable-highlight {\n\t\t\t\t\tcolor: ${d.BLUE} !important;\n\t\t\t\t}\n\n\t\t\t\t.timeline-Body {\n\t\t\t\t\tborder-top: none;\n\t\t\t\t\tborder-bottom: 2px solid ${d.BLACK};\n\t\t\t\t\tborder-radius: 3px;\n\t\t\t\t}\n\t\t\t`,twttr.widgets.createTimeline({sourceType:"profile",screenName:"jonwiedmann"},this.shadowRoot.querySelector(".col-right"),{width:620,height:520,theme:"dark",linkColor:d.BLUE,chrome:"nofooter"}).then(e=>{let n=e.contentDocument;n&&(n.head.appendChild(t),e.classList.add("twitter-timline-custom-styled"))})})}render(){return Object(o.c)(c||(c=s`
        ...
        `),d.BLUE,d.BLUE,d.BLUE)}}var m,u,h;m=p,u="styles",h=[i.default,r.default,Object(o.b)(l||(l=s`
			.col-left {
				min-width: 337px;
				max-width: 520px;
			}
