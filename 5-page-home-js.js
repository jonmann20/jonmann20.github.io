(window.webpackJsonp=window.webpackJsonp||[]).push([[7,3,11],{13:function(t,n,i){"use strict";i.r(n);var e=i(0),o=i(6),a=i(7),d=i(2);customElements.define("page-home",class extends e.a{constructor(){super(),document.title="Jon Wiedmann",d.a.addMeta("description","Jon Wiedmann's personal website.  A site with information on Jon's work experience and hobbies."),d.a.addMeta("keywords","Jon Wiedmann, Web Developer, HTML5, CSS, Javascript","Polymer"),d.a.addLink("preconnect","https://platform.twitter.com"),d.a.addLink("preconnect","https://cdn.syndication.twimg.com"),d.a.addLink("preconnect","https://syndication.twitter.com"),d.a.addLink("dns-prefetch","https://abs.twimg.com"),d.a.addLink("dns-prefetch","https://pbs.twimg.com"),d.a.addLink("dns-prefetch","https://ton.twimg.com")}firstUpdated(){d.a.require("https://platform.twitter.com/widgets.js").then(()=>{let t=document.createElement("style");t.type="text/css",t.innerHTML="\n\t\t\t\tbody {\n\t\t\t\t\tcolor: #fcfcfa;\n\t\t\t\t}\n\n\t\t\t\t.timeline-Widget {\n\t\t\t\t\tbackground: #2d2a2e;\n\t\t\t\t}\n\n\t\t\t\t.customisable-highlight {\n\t\t\t\t\tcolor: #66d9ef !important;\n\t\t\t\t}\n\n\t\t\t\t.timeline-Body {\n\t\t\t\t\tborder-top: none;\n\t\t\t\t\tborder-bottom: 2px solid #2d2a2e;\n\t\t\t\t\tborder-radius: 3px;\n\t\t\t\t}\n\t\t\t",twttr.widgets.createTimeline({sourceType:"profile",screenName:"jonwiedmann"},this.shadowRoot.querySelector(".col-right"),{width:620,height:520,theme:"dark",linkColor:"#66d9ef",chrome:"nofooter"}).then(n=>{n.contentDocument.head.appendChild(t),n.classList.add("twitter-timline-custom-styled")})})}render(){return e.c`
			<style>
				${o.default}
				${a.default}
