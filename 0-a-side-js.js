(window.webpackJsonp=window.webpackJsonp||[]).push([[0,11],{10:function(t,e,n){"use strict";n.r(e);var a=n(0),o=n(6);customElements.define("a-side",class extends a.a{static get properties(){return{active:{type:Boolean},selectedPage:{type:String}}}constructor(){super(),this.active=!1}render(){return a.c`
			<style>
				${o.default}
