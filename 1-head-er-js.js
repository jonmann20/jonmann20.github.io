(window.webpackJsonp=window.webpackJsonp||[]).push([[2,4],{11:function(e,i,t){"use strict";t.r(i);var n=t(23);let a;i.default=Object(n.b)(a||(a=(e=>e)`
	:host {
		display: block;
	}
...
`))},5:function(e,i,t){"use strict";t.r(i);var n=t(23),a=t(11);let o,s,d=e=>e;function r(e,i,t){return i in e?Object.defineProperty(e,i,{value:t,enumerable:!0,configurable:!0,writable:!0}):e[i]=t,e}class l extends n.a{constructor(){super(),this.asideIsActive=!1,this.initX=0,this.x=0,this.boundHideAside=e=>this.hideAside(e),this.boundSetInitX=e=>this.hideSetInitX(e),this.boundSetX=e=>this.hideSetX(e),window.onresize=()=>{window.innerWidth>800&&this.boundHideAside()},this.navVisible=window.page.includes("playground")}firstUpdated(){this.pNav=this.shadowRoot.querySelector(".playground-nav-wrap"),addEventListener("route",e=>{e.detail.includes("playground")?this.navVisible=!0:this.navVisible=!1},{passive:!0})}render(){return Object(n.c)(o||(o=d`
			<header>
				<nav>
					<a href="#home">
		...
		`))]),r(l,"properties",{page:{type:String}}),customElements.define("head-er",l)}}]);