...
["", "computergraphics.dart", , R, {
main: function() {
  R.Simulation$();
},

Sun: {"": "Object;x,y,r,oldX,oldY,vX,vY"},

Wave: {"": "Object;x,y"},

Simulation: {"": "Object;sun,wave,canvas,ctx,FULLW,FULLH,HALFW,HALFH,mouse_x,mouse_y,dt,oldTime,particlesY,diffuse,mouseDown",
  setupMouseEvts$0: function() {
    var t1, t2, slider;
    t1 = this.canvas;
    t1.toString;
    t1 = new W._ElementEventStreamImpl(t1, C.EventStreamProvider_mousedown._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.Simulation_setupMouseEvts_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = new W._EventStream(window, C.EventStreamProvider_mouseup._eventType, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new R.Simulation_setupMouseEvts_closure0(this)), t2._useCapture);
    ...
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.Simulation_setupMouseEvts_closure1(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    slider = document.querySelector(".diffusionRate");
    slider.toString;
    t2 = new W._ElementEventStreamImpl(slider, C.EventStreamProvider_change._eventType, false);
    H.setRuntimeTypeInfo(t2, [null]);
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new R.Simulation_setupMouseEvts_closure2(this, slider)), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
    t1 = window;
    t2 = this.get$runSim();
  ...
  get$runSim: function() {
    return new H.BoundClosure$1(this, R.Simulation.prototype.runSim$1, null, "runSim$1");
  },
  update$0: function() {
    var t1 = this.sun;
    t1.x = this.mouse_x;
    t1.y = this.mouse_y;
    this.particlesY = this.particlesY - 0.01;
  },
  render$0: function() {
    J.set$fillStyle$x(this.ctx, "#bbd9ee");
    J.fillRect$4$x(this.ctx, 0, 0, this.FULLW, this.FULLH);
    this.drawCircle$1("255, 165, 0");
  },
  drawCircle$1: function(c) {
    var t1, t2, t3, t4, t5, rad;
    ...
    t4 = t2.y;
    t5 = t2.r;
    rad = J.createRadialGradient$6$x(t1, t3, t4, 1, t3, t4, t5);
    rad.addColorStop(0, "rgba(" + c + ",1)");
    rad.addColorStop(1, "rgba(" + c + "," + J.toString$0(this.diffuse) + ")");
    J.set$fillStyle$x(this.ctx, rad);
    J.arc$6$x(this.ctx, t2.x, t2.y, t5, 0, 6.283185307179586, false);
    J.fill$0$x(this.ctx);
  },
  Simulation$0: function() {
    ...
    t1.x = t2;
    t1.y = this.mouse_y;
    this.setupMouseEvts$0();
  },
  static: {
Simulation$: function() {
  var t1 = new R.Simulation(new R.Sun(0, 0, 70, 0, 0, 0, 0), new R.Wave(0, 0), null, null, null, null, null, null, null, 70, 0, 0, 0, 0.08, false);
  t1.Simulation$0();
  return t1;
}}
...
Simulation_setupMouseEvts_closure: {"": "Closure;this_0",
  call$1: function(e) {
    J.preventDefault$0$x(e);
    this.this_0.mouseDown = true;
  },
  $is_args1: true
},

Simulation_setupMouseEvts_closure0: {"": "Closure;this_1",
  call$1: function(e) {
    this.this_1.mouseDown = false;
  },
  $is_args1: true
},

Simulation_setupMouseEvts_closure1: {"": "Closure;this_2",
  call$1: function(e) {
    var t1, t2, t3, t4;
    t1 = this.this_2;
    if (t1.mouseDown) {
      ...
      t3 = t3.get$x(t3);
      t4 = t1.canvas;
      t4 = new P.Rectangle(t4.offsetLeft, t4.offsetTop, t4.offsetWidth, t4.offsetHeight);
...
Simulation_setupMouseEvts_closure2: {"": "Closure;this_3,slider_4",
  call$1: function(e) {
    var t1 = this.this_3;
    t1.diffuse = J.get$value$x(this.slider_4);
    J.set$innerHtml$x(document.querySelector(".litDiffusion"), J.toString$0(t1.diffuse));
  },
  $is_args1: true
}},
1],
...
InputElement: {"": "HtmlElement;height},name=,value=,width}", $isElement: true, "%": "HTMLInputElement"},
...
function dart_precompiled($collectedClasses) {
  ...
  function Sun(x, y, r, oldX, oldY, vX, vY) {
    this.x = x;
    this.y = y;
    this.r = r;
    this.oldX = oldX;
  ...
  Wave.builtin$cls = "Wave";
  if (!"name" in Wave)
    Wave.name = "Wave";
  $desc = $collectedClasses.Wave;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Wave.prototype = $desc;
  function Simulation(sun, wave, canvas, ctx, FULLW, FULLH, HALFW, HALFH, mouse_x, mouse_y, dt, oldTime, particlesY, diffuse, mouseDown) {
    this.sun = sun;
    this.wave = wave;
    this.canvas = canvas;
    this.ctx = ctx;
  ...
  Simulation.builtin$cls = "Simulation";
  if (!"name" in Simulation)
    Simulation.name = "Simulation";
  $desc = $collectedClasses.Simulation;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Simulation.prototype = $desc;
  function Simulation_setupMouseEvts_closure(this_0) {
    this.this_0 = this_0;
  }
  Simulation_setupMouseEvts_closure.builtin$cls = "Simulation_setupMouseEvts_closure";
  if (!"name" in Simulation_setupMouseEvts_closure)
    Simulation_setupMouseEvts_closure.name = "Simulation_setupMouseEvts_closure";
  $desc = $collectedClasses.Simulation_setupMouseEvts_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Simulation_setupMouseEvts_closure.prototype = $desc;
  function Simulation_setupMouseEvts_closure0(this_1) {
    this.this_1 = this_1;
  }
  Simulation_setupMouseEvts_closure0.builtin$cls = "Simulation_setupMouseEvts_closure0";
  if (!"name" in Simulation_setupMouseEvts_closure0)
    Simulation_setupMouseEvts_closure0.name = "Simulation_setupMouseEvts_closure0";
  $desc = $collectedClasses.Simulation_setupMouseEvts_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Simulation_setupMouseEvts_closure0.prototype = $desc;
  function Simulation_setupMouseEvts_closure1(this_2) {
    this.this_2 = this_2;
  }
  Simulation_setupMouseEvts_closure1.builtin$cls = "Simulation_setupMouseEvts_closure1";
  if (!"name" in Simulation_setupMouseEvts_closure1)
    Simulation_setupMouseEvts_closure1.name = "Simulation_setupMouseEvts_closure1";
  $desc = $collectedClasses.Simulation_setupMouseEvts_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Simulation_setupMouseEvts_closure1.prototype = $desc;
  function Simulation_setupMouseEvts_closure2(this_3, slider_4) {
    this.this_3 = this_3;
    this.slider_4 = slider_4;
  }
  Simulation_setupMouseEvts_closure2.builtin$cls = "Simulation_setupMouseEvts_closure2";
  if (!"name" in Simulation_setupMouseEvts_closure2)
    Simulation_setupMouseEvts_closure2.name = "Simulation_setupMouseEvts_closure2";
  $desc = $collectedClasses.Simulation_setupMouseEvts_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Simulation_setupMouseEvts_closure2.prototype = $desc;
