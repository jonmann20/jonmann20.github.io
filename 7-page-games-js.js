(window.webpackJsonp=window.webpackJsonp||[]).push([[15,8,9,10],{11:function(e,a,i){"use strict";i.r(a);var t=i(26);a.default=t.b`
	:host {
		display: block;
	}
...
`},12:function(e,a,i){"use strict";i.r(a);var t=i(26);a.default=t.b`
	.col-left ul {
		font-size: 1.15em;
	}
...
`},14:function(e,a,i){"use strict";i.r(a);var t=i(26);a.default=t.b`
	:host {
		position: relative;
	}
...
`},19:function(e,a,i){"use strict";i.r(a);var t,n,o,l=i(26),s=i(11),r=i(12),d=i(14),g=i(28);class m extends l.a{constructor(){super(),document.title="Games"}firstUpdated(){new g.a(this.shadowRoot.querySelector(".col-left ul"),this.shadowRoot)}render(){return l.c`
        ...
        `}}t=m,n="styles",o=[s.default,r.default,d.default,l.b`
			.lh {
				list-style-type: none;
				margin: 12px 0 8px;
				padding-left: 0;
		...
		`],n in t?Object.defineProperty(t,n,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[n]=o,customElements.define("page-games",m)},28:function(e,a,i){"use strict";a.a=class{constructor(e,a){let i,t="default",n=Array.from(e.querySelectorAll("a"));a=a||document,n.forEach(e=>{e.addEventListener("click",e=>{(i=e.target.id)&&t!==i&&(e.preventDefault(),a.querySelector(`#div-${t}`).classList.remove("fade-in"),a.querySelector(`#div-${i}`).classList.add("fade-in"),t=i)})})}}}}]);